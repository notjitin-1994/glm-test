...
let react_syntax_highlighter_dist_esm_styles_prism = require("react-syntax-highlighter/dist/esm/styles/prism");
...
let _openuidev_react_lang = require("@openuidev/react-lang");
...
const Accordion = (0, react.forwardRef)(({ className, style, variant = "clear", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Root, {
	ref,
	className: (0, clsx.default)("openui-accordion", variantMap$7[variant], className),
	style,
	...props
}));
const AccordionItem = (0, react.forwardRef)(({ className, style, value, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Item, {
	ref,
	className: (0, clsx.default)("openui-accordion-item", className),
	style,
	value,
	...props
}));
const AccordionTrigger = (0, react.forwardRef)(({ className, style, text, icon, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Header, {
	className: (0, clsx.default)("openui-accordion-header"),
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_accordion.Trigger, {
		ref,
		className: (0, clsx.default)("openui-accordion-trigger", className),
		style,
		...props,
		...
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronDownIcon, { className: "openui-accordion-trigger-icon" })]
	})
}));
const AccordionContent = (0, react.forwardRef)(({ className, style, children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Content, {
	ref,
	className: (0, clsx.default)("openui-accordion-content", className),
	style,
	...props,
...
const ThemeProvider = ({ mode = "light", children, lightTheme, darkTheme, theme: deprecatedTheme, cssSelector = "body" }) => {
	...
	const isNested = (0, react.useContext)(InternalContext) != null;
...
const DefaultHeader = ({ title, onClose }) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
	...
	children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.X, { size: 16 })
	})]
});
/**
...
* @category Components
*/
const ArtifactPanel = (0, react.forwardRef)(({ artifactId, children, title, className, errorFallback, header = true }, ref) => {
	const { isActive, close } = (0, _openuidev_react_headless.useArtifact)(artifactId);
	const { node: panelNode } = (0, _openuidev_react_headless.useArtifactPortalTarget)();
	...
	return (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		className: (0, clsx.default)("openui-artifact-panel", portalThemeClassName, className),
		role: "region",
		"aria-label": title ?? "Artifact panel",
		children: [headerContent, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ArtifactErrorBoundary, {
...
function Artifact(config) {
	...
	const ArtifactComponent = ({ props }) => {
		const artifactId = (0, react.useId)();
		const { isActive, open, close, toggle } = (0, _openuidev_react_headless.useArtifact)(artifactId);
		const controls = {
			isActive,
			open,
			close,
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [preview(props, controls), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ArtifactPanel, {
			artifactId,
			title: resolvedTitle,
			...panelProps,
...
const Button = (0, react.forwardRef)(({ children, variant = "primary", size = "medium", iconLeft, iconRight, className, buttonType = "normal", ...props }, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
		ref,
		className: (0, clsx.default)("openui-button-base", (buttonType === "destructive" ? destructiveVariantMap : normalVariantMap)[variant], sizeMap$2[size], className),
		...props,
		children: [
			iconLeft,
			children,
...
const Buttons = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-buttons", variantMap$6[variant], className),
		style,
		...rest,
		children
	});
...
const SelectGroup = (0, react.forwardRef)(({ className, style, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Group, {
	ref,
	className: (0, clsx.default)("openui-select-group", className),
	style,
	...props
}));
...
const SelectTrigger = (0, react.forwardRef)(({ className, style, children, hideDropdownIcon, size, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_select.Trigger, {
		ref,
		className: (0, clsx.default)("openui-select-trigger", sizeMap$1[resolvedSize], className),
		style,
		...props,
		children: [children, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Icon, {
			asChild: true,
			children: !hideDropdownIcon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronDown, { className: "openui-select-trigger-icon" })
		})]
	});
});
const SelectContent = (0, react.forwardRef)(({ className, children, position = "popper", ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Portal, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Content, {
		ref,
		className: (0, clsx.default)("openui-select-content", sizeContext && `openui-select-content-${sizeContext.size}`, className, portalThemeClassName),
		position,
		sideOffset: 2,
		...props,
...
const SelectLabel = (0, react.forwardRef)(({ className, style, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Label, {
	ref,
	className: (0, clsx.default)("openui-select-label", className),
	style,
	...props
}));
const SelectItem = (0, react.forwardRef)(({ className, style, children, showTick = true, textValue, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_select.Item, {
	ref,
	className: (0, clsx.default)("openui-select-item", showTick ? "openui-select-item--with-tick" : "openui-select-item--without-tick", className),
	style,
	...props,
	children: [
		showTick && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			className: "openui-select-item-check-wrapper",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.ItemIndicator, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Check, { className: "openui-select-item-check-icon" }) })
		}),
...
const SelectSeparator = (0, react.forwardRef)(({ className, style, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Separator, {
	ref,
	className: (0, clsx.default)("openui-select-separator", className),
	style,
	...props
}));
//#endregion
...
const SelectContent$1 = (0, react.forwardRef)(({ className, children, position = "popper", viewportClassName, container, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Portal, {
	...
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Content, {
		ref,
		className: (0, clsx.default)("openui-select-content", className),
		position,
		...props,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_select.Viewport, {
			className: (0, clsx.default)("openui-select-viewport", viewportClassName),
			"data-position": position,
			children
		})
	})
...
const MonthsDropdown = (props) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Select, {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectTrigger, {
			className: (0, clsx.default)("openui-calendar-select-trigger", className),
...
const YearsDropdown = (props) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Select, {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SelectTrigger, {
			...
			viewportClassName: (0, clsx.default)("openui-calendar-select-viewport", botType === "mobile" && "openui-calendar-select-viewport-mobile"),
			sideOffset: 4,
			alignOffset: -75,
			style: {
...
const Calendar = (0, react.forwardRef)(({ className, classNames, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		className: (0, clsx.default)("openui-calendar-container", className),
...
const Callout = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-callout", variantMap$5[variant], duration && "openui-callout-autodismiss", className),
		style: dismissStyle,
		...rest,
...
const Card = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-card", className, variantMap$4[variant], widthMap[width]),
		...rest,
		children
	});
});
...
const CardHeader = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-header", className),
		style: styles,
		...rest,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const IconButton = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		ref,
		className: (0, clsx.default)("openui-icon-button", (appearance === "normal" ? normalIconButtonVariants : destructiveIconButtonVariants)[variant], iconButtonSizes[size], iconButtonShapes[shape], className),
		...rest,
		children: icon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const Carousel = (0, react.forwardRef)(({ itemsToScroll = 1, noSnap, showButtons = true, variant = "card", className, children, onScrollLeftEnabled, onScrollRightEnabled, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CarouselContext.Provider, {
		value: contextValue,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: (0, clsx.default)("openui-carousel", `openui-carousel--${variant}`, className),
			...props,
			children
		})
	});
...
const CarouselContent = (0, react.forwardRef)(({ className, children, ...props }, _ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref: scrollDivRef,
		className: (0, clsx.default)("openui-carousel-content", {
...
const CarouselItem = (0, react.forwardRef)(({ className, children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	ref,
	className: (0, clsx.default)("openui-carousel-item", className),
	...props,
	children
}));
const CarouselPrevious = (0, react.forwardRef)(({ className, style, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-carousel-button openui-carousel-button-left", className),
...
const CarouselNext = (0, react.forwardRef)(({ className, style, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-carousel-button openui-carousel-button-right", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			ref,
			shape: "square",
			variant: "secondary",
...
const ChartContainer = (0, react.forwardRef)(({ id, className, children, config, rechartsProps, style, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChartContext.Provider, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			"data-chart": chartId,
			ref,
			className: (0, clsx.default)("openui-chart-container", className),
			style: {
...
function ChartTooltipContentRender({ active, payload, className, indicator = "dot", hideLabel = false, hideIndicator = false, label, labelFormatter, labelClassName, formatter, color, nameKey, labelKey, showPercentage = false }, ref) {
	...
	const tooltipLabel = (0, react.useMemo)(() => {
		...
		if (labelFormatter) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: (0, clsx.default)("openui-chart-tooltip-label-heavy", labelClassName),
			children: labelFormatter(value, payload)
		});
		if (!value) return null;
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: (0, clsx.default)("openui-chart-tooltip-label", labelClassName),
			children: value
		});
	}, [
		label,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-chart-tooltip", className),
		children: [!nestLabel && tooltipLabel, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: payload.map((item, index) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: (0, clsx.default)("openui-chart-tooltip-content-item", indicator === "dot" && "openui-chart-tooltip-content-item--dot"),
					children: formatter && item?.value !== void 0 && item.name ? formatter(item.value, item.name, item, index, item.payload) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [itemConfig?.icon ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(itemConfig.icon, {}) : !hideIndicator && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: (0, clsx.default)("openui-chart-tooltip-content-indicator", `openui-chart-tooltip-content-indicator--${indicator}`),
						style: {
							"--color-bg": indicatorColor,
							"--color-border": indicatorColor
						}
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: (0, clsx.default)("openui-chart-tooltip-content-value-wrapper", nestLabel ? "openui-chart-tooltip-content-value-wrapper--nested" : "openui-chart-tooltip-content-value-wrapper--standard"),
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							className: (0, clsx.default)("openui-chart-tooltip-content-value", showPercentage && "percentage"),
...
const ChartLegendContent = (0, react.forwardRef)(({ className, hideIcon = false, payload, verticalAlign = "bottom", nameKey }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-chart-legend", `openui-chart-legend--${verticalAlign}`, className),
...
const useDefaultLegend = ({ items, containerWidth, buttonWidth, isExpanded }) => {
	...
	const calculateItemWidth = (0, react.useMemo)(() => (item) => {
	...
	const { visibleItems, hasMoreItems } = (0, react.useMemo)(() => {
	...
	return {
		displayItems: (0, react.useMemo)(() => isExpanded ? items : visibleItems, [
			isExpanded,
			items,
			visibleItems
		]),
		hasMoreItems,
		toggleButtonText: (0, react.useMemo)(() => {
...
const DefaultLegend = (0, react.memo)(react.default.forwardRef(({ items, className, yAxisLabel, xAxisLabel, containerWidth, isExpanded, setIsExpanded, style }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-chart-legend-container openui-chart-legend--bottom", className),
		style,
		children: [(xAxisLabel || yAxisLabel) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			className: (0, clsx.default)("openui-chart-legend", {
			...
			children: [displayItems.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				iconRight: isExpanded ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronUpIcon, { className: "openui-chart-legend-toggle-button-icon" }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronDownIcon, { className: "openui-chart-legend-toggle-button-icon" }),
...
const FloatingUIPortal = ({ children, className = "", chartId, portalContainer, position, placement = "right-start", offsetDistance = 20 }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		className: (0, clsx.default)("openui-portal-tooltip", portalThemeClassName, className),
		"data-chart": chartId,
...
function CustomTooltipContentRender(props, ref) {
	...
	const payloadItems = (0, react.useMemo)(() => {
		...
		const renderPayloadItem = (item, index, isTwoItemsLayout) => {
			...
			const indicatorColor = (color ?? item.payload?.fill) || item.color;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: (0, clsx.default)("openui-chart-tooltip-content-item", !isTwoItemsLayout && indicator === DEFAULT_INDICATOR && "openui-chart-tooltip-content-item--dot"),
				children: [formatter && item?.value !== void 0 && item.name ? formatter(item.value, item.name, item, index, item.payload) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [itemConfig?.icon ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(itemConfig.icon, {}) : !hideIndicator && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: (0, clsx.default)("openui-chart-tooltip-content-indicator", `openui-chart-tooltip-content-indicator--${indicator}`, isTwoItemsLayout && "openui-chart-tooltip-content-indicator--two-items"),
					style: {
						"--color-bg": indicatorColor,
						"--color-border": indicatorColor
					}
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: (0, clsx.default)("openui-chart-tooltip-content-value-wrapper", isTwoItemsLayout && "openui-chart-tooltip-content-value-wrapper--vertical", nestLabel ? "openui-chart-tooltip-content-value-wrapper--nested" : "openui-chart-tooltip-content-value-wrapper--standard"),
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						className: "openui-chart-tooltip-content-label",
						children: [nestLabel && tooltipLabel, /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: itemConfig?.label || item.name })]
					}), item.value !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				})] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-chart-tooltip-content-item-separator" })]
			}, `${item.dataKey}-${index}`);
		};
	...
	const tooltipContent = /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			isGreaterThanTen && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-chart-tooltip-content-item-separator" }),
...
const ScrollButtonsHorizontal = react.default.memo(({ dataWidth, effectiveWidth, canScrollLeft, canScrollRight, isSideBarTooltipOpen, onScrollLeft, onScrollRight }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			className: (0, clsx.default)("openui-chart-horizontal-scroll-button openui-chart-horizontal-scroll-button--left", { "openui-chart-horizontal-scroll-button--disabled": !canScrollLeft }),
			...
			className: (0, clsx.default)("openui-chart-horizontal-scroll-button openui-chart-horizontal-scroll-button--right", {
...
const ScrollButtonsVertical = react.default.memo(({ dataHeight, effectiveHeight, canScrollUp, canScrollDown, isSideBarTooltipOpen, onScrollUp, onScrollDown }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			className: (0, clsx.default)("openui-chart-vertical-scroll-button openui-chart-vertical-scroll-button--up", { "openui-chart-vertical-scroll-button--disabled": !canScrollUp }),
			...
			className: (0, clsx.default)("openui-chart-vertical-scroll-button openui-chart-vertical-scroll-button--down", {
...
const SideBarTooltip = react.default.memo(({ height }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-chart-side-bar-tooltip-content-item-separator" }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				}), !value.isLast && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-chart-side-bar-tooltip-content-item-separator" })] }, index))
			})
		]
	});
});
...
const Separator = ({ className, ...props }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_separator.Root, {
		className: (0, clsx.default)("openui-separator", className),
		...props
	});
};
//#endregion
...
const StackedLegend = ({ items, onItemHover, activeKey, onLegendItemHover, containerWidth, separator = false, showTitle = true, layout = "auto", className, style }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref: containerRef,
		className: (0, clsx.default)("openui-stacked-legend-container", className),
		style: {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				}), index !== itemsToDisplay.length - 1 && separator && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Separator, { className: "openui-stacked-legend-separator" })] }, item.key))
			}),
...
const SVGXAxisTick = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
		ref,
		className: (0, clsx.default)("openui-chart-svg-x-axis-tick", angle !== 0 && "openui-chart-svg-x-axis-tick-angled", className),
		x,
		y,
		dy,
		textAnchor,
...
const AreaChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant: areaChartVariant = "natural", tickVariant = "multiLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LabelTooltipProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-area-chart-container", className),
...
const AreaChartCondensedComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant: areaChartVariant = "natural", tickVariant = "singleLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height = CHART_HEIGHT$2, width }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LabelTooltipProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		setData: setSideBarTooltipData,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-area-chart-condensed-container", className),
			"data-openui-chart": exportData,
			style: { width: width ? `${width}px` : void 0 },
			children: [
...
const BarChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "grouped", tickVariant = "multiLine", grid = true, icons = {}, radius, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LabelTooltipProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		setData: setSideBarTooltipData,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-bar-chart-container", className),
			"data-openui-chart": exportData,
			style: { width: width ? `${width}px` : void 0 },
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const BarChartCondensedComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "grouped", tickVariant = "singleLine", grid = true, icons = {}, radius, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height = CHART_HEIGHT$1, width, maxBarWidth = DEFAULT_MAX_BAR_WIDTH }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LabelTooltipProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		setData: setSideBarTooltipData,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-bar-chart-condensed-container", className),
			"data-openui-chart": exportData,
			style: { width: width ? `${width}px` : void 0 },
			children: [
				yAxisLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const HorizontalBarChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "grouped", grid = true, icons = {}, radius = BAR_RADIUS, isAnimationActive = false, showXAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LabelTooltipProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		setData: setSideBarTooltipData,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-horizontal-bar-chart-container", className),
			"data-openui-chart": exportData,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const LineChart = ({ data, categoryKey, theme = "ocean", customPalette, variant: lineChartVariant = "natural", tickVariant = "multiLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width, strokeWidth = 2 }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LabelTooltipProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		setData: setSideBarTooltipData,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-line-chart-container", className),
			"data-openui-chart": exportData,
			style: { width: width ? `${width}px` : void 0 },
			children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const LineChartCondensedComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant: lineChartVariant = "natural", tickVariant = "singleLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height = CHART_HEIGHT, width, strokeWidth = 2 }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LabelTooltipProvider, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		setData: setSideBarTooltipData,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-line-chart-condensed-container", className),
			"data-openui-chart": exportData,
			style: { width: width ? `${width}px` : void 0 },
			children: [
				yAxisLabel && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const MiniAreaChart = ({ data, theme = "ocean", customPalette, variant: areaChartVariant = "natural", opacity = .5, isAnimationActive = false, onAreaClick, size = "100%", className, areaColor, useGradient = true }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChartContainer, {
		...
		onClick: onAreaClick,
		ref: containerRef,
		className: (0, clsx.default)("openui-charts-mini-area-chart-container", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(recharts.AreaChart, {
			accessibilityLayer: true,
			data: chartData,
			margin: { top: 10 },
...
const MiniBarChart = ({ data, theme = "ocean", customPalette, radius = 1, isAnimationActive = false, onBarsClick, size = "100%", className, barColor }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChartContainer, {
		...
		onClick: onBarsClick,
		ref: containerRef,
		className: (0, clsx.default)("openui-charts-mini-bar-chart-container", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(recharts.BarChart, {
			accessibilityLayer: true,
			data: chartData,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(recharts.XAxis, {
...
const MiniLineChart = ({ data, theme = "ocean", customPalette, variant: lineChartVariant = "natural", strokeWidth = 2, isAnimationActive = true, onLineClick, size = "100%", className, lineColor }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ChartContainer, {
		...
		onClick: onLineClick,
		ref: containerRef,
		className: (0, clsx.default)("openui-charts-mini-line-chart-container", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(recharts.LineChart, {
			accessibilityLayer: true,
			data: chartData,
			margin: { top: 10 },
...
const PieChartComponent = ({ data, categoryKey, dataKey, theme = "ocean", customPalette, variant = "pie", format = "number", legend = true, legendVariant = "stacked", isAnimationActive = true, appearance = "circular", cornerRadius, paddingAngle = 0, onMouseEnter, onMouseLeave, onClick, className, maxChartSize = MAX_CHART_SIZE$2, minChartSize = MIN_CHART_SIZE$2, height, width }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref: wrapperRef,
		className: (0, react.useMemo)(() => (0, clsx.default)("openui-pie-chart-container-wrapper", className, {
	...
	*/
	...
	(0, react.useLayoutEffect)(() => {
		...
		const updatePosition = () => {
			...
			labelEl.className = (0, clsx.default)("openui-chart-polar-angle-axis-label", className);
...
const RadarChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant = "line", grid = true, legend = true, strokeWidth = 2, areaOpacity = .2, icons = {}, isAnimationActive = false, height, width }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			ref: wrapperRef,
			className: (0, react.useMemo)(() => (0, clsx.default)("openui-radar-chart-container-wrapper", { "layout-column": true }), []),
			style: (0, react.useMemo)(() => {
				const formatDimension = (value) => {
					if (typeof value === "number") return `${value}px`;
					return value;
...
const RadialChart = ({ data, categoryKey, dataKey, theme = "ocean", customPalette, variant = "circular", format = "number", legend = true, legendVariant = "stacked", grid = false, isAnimationActive = false, cornerRadius = 10, onMouseEnter, onMouseLeave, onClick, className, maxChartSize = MAX_CHART_SIZE, minChartSize = MIN_CHART_SIZE, height, width }) => {
	...
	const wrapperClassName = (0, clsx.default)("openui-radial-chart-container-wrapper", className, {
		"layout-row": isRowLayout,
		"layout-column": !isRowLayout,
		"legend-default": legend && legendVariant === "default",
		"legend-stacked": legend && legendVariant === "stacked"
...
const ScatterChart = ({ data, xAxisDataKey = "x", yAxisDataKey = "y", theme = "ocean", customPalette, grid = true, xAxisLabel, yAxisLabel, legend = true, isAnimationActive = false, className, height, width, shape = "circle" }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(SideBarTooltipProvider, {
		...
		setData: setSideBarTooltipData,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-scatter-chart-container", className),
			"data-openui-chart": exportData,
			style: {
...
const SingleStackedBar = ({ data, categoryKey, dataKey, theme = "ocean", customPalette, legend = true, legendVariant = "default", className, style, animated = true }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref: wrapperRef,
		className: (0, clsx.default)("openui-single-stacked-bar-chart-container", className, { "openui-single-stacked-bar-chart-container-gap": legend && legendVariant === "default" }),
		style,
		"data-openui-chart": exportData,
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: segments.map((segment, index) => {
					...
					return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						className: (0, clsx.default)("openui-single-stacked-bar-chart-segment", { "openui-single-stacked-bar-chart-animated": animated }),
						style: {
						...
						children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-single-stacked-bar-chart-segment-line" })
					}, `segment-${index}`);
				})
			}),
...
const CheckBoxGroup = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-checkbox-group", variantMap$3[variant], className),
		style,
		children
	});
});
...
const CheckBoxItem = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_checkbox.Root, {
			...
			id,
			className: (0, clsx.default)("openui-checkbox-item-root", className),
			disabled,
			required,
...
const CodeBlock = ({ language, codeString, theme }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			...
			variant: "secondary",
			size: "small",
			className: (0, clsx.default)("openui-code-block-copy-button", { "openui-code-block-copy-button-copied": copied }),
			...
			style: theme ?? react_syntax_highlighter_dist_esm_styles_prism.vscDarkPlus,
			language,
			PreTag: "div",
...
const Container$2 = ({ children, logoUrl, agentName, className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShellStoreProvider, {
		logoUrl,
		agentName,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LayoutContextProvider, {
			layout: "tray",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: (0, clsx.default)("openui-copilot-shell-container", className),
				children
			})
		})
	});
...
const ConversationStarterItem$2 = ({ displayText, prompt, onClick, variant, icon }) => {
	...
	if (variant === "short") return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
		...
		children: [renderedIcon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const ConversationStarter$2 = ({ starters, className, variant = "short" }) => {
	const processMessage = (0, _openuidev_react_headless.useThread)((s) => s.processMessage);
	const isRunning = (0, _openuidev_react_headless.useThread)((s) => s.isRunning);
	const messages = (0, _openuidev_react_headless.useThread)((s) => s.messages);
	const isLoadingMessages = (0, _openuidev_react_headless.useThread)((s) => s.isLoadingMessages);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-copilot-shell-conversation-starter", `openui-copilot-shell-conversation-starter--${variant}`, className),
		children: starters.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStarterItem$2, {
			displayText: item.displayText,
			prompt: item.prompt,
			icon: item.icon,
			onClick: handleClick,
			variant
		}), variant === "long" && index < starters.length - 1 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: "openui-copilot-shell-conversation-starter__separator",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Separator, {})
...
const Header$1 = ({ className, rightChildren }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-copilot-shell-header", className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		}), rightChildren && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const Table = react.default.forwardRef(({ className, containerRef, containerClassName, containerStyle, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
	ref: containerRef,
	className: (0, clsx.default)("openui-table-container", containerClassName),
	style: containerStyle,
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("table", {
		ref,
		className: (0, clsx.default)("openui-table", className),
		...props
	})
}));
...
const TableHead = react.default.forwardRef(({ className, children, icon, align, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("th", {
	ref,
	className: (0, clsx.default)("openui-table-head", className),
	...props,
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-table-head-content", align && alignmentClasses[align]),
...
const TableCell = react.default.forwardRef(({ className, align, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("td", {
	ref,
	className: (0, clsx.default)("openui-table-cell", align && alignmentClasses[align], className),
	...props
}));
...
const ScrollableTable = react.default.forwardRef(({ className, containerClassName, containerStyle, children, ...tableProps }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [isScrollable && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: (0, clsx.default)("openui-scrollable-table-control", "openui-scrollable-table-control-left", !canScrollLeft && "openui-scrollable-table-control-disabled"),
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			...
			className: (0, clsx.default)("openui-scrollable-table-control", "openui-scrollable-table-control-right", !canScrollRight && "openui-scrollable-table-control-disabled"),
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			...
			containerClassName: (0, clsx.default)("openui-scrollable-table-scroll-container", containerClassName),
			containerStyle,
			className,
...
const MarkDownRenderer = (0, react.memo)((props) => {
	const { mode } = useTheme();
	const theme = mode === "dark" ? react_syntax_highlighter_dist_esm_styles_prism.vscDarkPlus : react_syntax_highlighter_dist_esm_styles_prism.oneLight;
	const components = {
		code({ className, children, ...props }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
				className: (0, clsx.default)("openui-markdown-renderer-code", className),
				...props,
				children
			});
		},
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)(props["variant"] && variantStyles[props["variant"]], "openui-markdown-renderer", props.className),
...
const MessageLoading = ({ className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-message-loading-container", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-message-loading" })
	});
};
//#endregion
...
const ToolCallComponent = ({ toolCall, isStreaming, toolsDone, isLast = false, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-tool-call", className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "openui-tool-call__title-row",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: (0, clsx.default)("openui-tool-call__icon-wrapper", { "openui-tool-call__icon--blinking": isRunning && isLast }),
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.SquareCode, {
					size: 14,
					className: "openui-tool-call__icon"
				})
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: (0, clsx.default)("openui-tool-call__name", { "openui-tool-call__name--shimmer": isRunning && isLast }),
				children: actionLabel
			})]
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: (0, clsx.default)("openui-tool-call__connector", { "openui-tool-call__connector--last": isLast }),
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const ToolCodeBlock = ({ type, code, isRunning = false, toolName }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
			...
			type: "button",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
				className: (0, clsx.default)("openui-tool-code-block__label", { "openui-tool-code-block__label--loading": isRunning }),
				children: isRunning ? runningLabel : label
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronDown, {
				size: 14,
				className: (0, clsx.default)("openui-tool-code-block__chevron", { "openui-tool-code-block__chevron--expanded": isExpanded })
			})]
		}), isExpanded && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const ToolResult = ({ message, toolName, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-tool-result", className, { "openui-tool-result--error": hasError }),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				size: 14,
				className: (0, clsx.default)("openui-tool-result__chevron", { "openui-tool-result__chevron--expanded": isExpanded })
			})]
...
const Composer$2 = ({ className, placeholder = "Type your message..." }) => {
	...
	const processMessage = (0, _openuidev_react_headless.useThread)((s) => s.processMessage);
	const cancelMessage = (0, _openuidev_react_headless.useThread)((s) => s.cancelMessage);
	const isRunning = (0, _openuidev_react_headless.useThread)((s) => s.isRunning);
	const isLoadingMessages = (0, _openuidev_react_headless.useThread)((s) => s.isLoadingMessages);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-copilot-shell-thread-composer", className),
		onClick: (e) => {
...
const ThreadContainer$2 = ({ children, className }) => {
	const isLoadingMessages = (0, _openuidev_react_headless.useThread)((s) => s.isLoadingMessages);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-copilot-shell-thread-container", className),
		style: { visibility: isLoadingMessages ? "hidden" : void 0 },
		children: [children, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ArtifactOverlay, {})]
	});
};
const ScrollArea$2 = ({ children, className, scrollVariant = "user-message-anchor", userMessageSelector = ".openui-copilot-shell-thread-message-user" }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			ref,
			className: (0, clsx.default)("openui-copilot-shell-thread-scroll-area", { "openui-copilot-shell-thread-scroll-area--user-message-anchor": scrollVariant === "user-message-anchor" }, className),
			children
		})
	});
};
const AssistantMessageContainer$2 = ({ children, className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-copilot-shell-thread-message-assistant", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const UserMessageContainer$2 = ({ children, className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-copilot-shell-thread-message-user", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const AssistantMessageContent$2 = ({ message, allMessages }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
		message.content && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MarkDownRenderer, {
			textMarkdown: message.content,
			className: "openui-copilot-shell-thread-message-assistant__text"
		}),
		message.toolCalls?.map((toolCall) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToolCallComponent, { toolCall }, toolCall.id)),
		toolMessages.map((tm) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToolResult, {
			message: tm,
...
const UserMessageContent$2 = ({ message }) => {
	...
	if (typeof content === "string") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: content });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: content?.map((part, i) => {
		if (part.type === "text") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: part.text }, i);
		if (part.type === "binary" && part.url) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
			src: part.url,
			alt: "",
...
const RenderMessage$2 = (0, react.memo)(({ message, className, allMessages, assistantMessage: CustomAssistantMessage, userMessage: CustomUserMessage, isStreaming }) => {
	...
	if (message.role === "assistant") {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantMessageContainer$2, {
			className,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantMessageContent$2, {
				message,
				allMessages
			})
		});
	...
	if (message.role === "user") {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserMessageContainer$2, {
			className,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserMessageContent$2, { message })
		});
	}
	return null;
});
const MessageLoading$3 = () => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MessageLoading, {})
	});
};
const Messages$2 = ({ className, loader, assistantMessage, userMessage }) => {
	...
	const isRunning = (0, _openuidev_react_headless.useThread)((s) => s.isRunning);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-copilot-shell-thread-messages", className),
		children: [messages.map((message, i) => {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_openuidev_react_headless.MessageProvider, {
				message,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderMessage$2, {
					message,
...
const WelcomeScreen$2 = (props) => {
	...
	const messages = (0, _openuidev_react_headless.useThread)((s) => s.messages);
	if (!isChatEmpty({
		isLoadingMessages: (0, _openuidev_react_headless.useThread)((s) => s.isLoadingMessages),
		messages
	})) return null;
	if ("children" in props && props.children) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-copilot-shell-welcome-screen", className),
		children: props.children
	});
	const { title, description, image } = props;
	const renderImage = () => {
		if (!image) return null;
		if (isImageUrl$2(image)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
			src: image.url,
			alt: title || "",
...
const DatepickerRenderer = (0, react.forwardRef)(({ className, style }, ref) => {
	...
	if (mode === "single") return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-date-picker-renderer-single-mode", className),
		style,
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-date-picker-renderer-range-mode", className),
		style,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Calendar, {
			mode: "range",
...
const FloatingDateInput = () => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-date-picker-renderer-floating-input-container", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
			...
			size: 16,
			className: (0, clsx.default)({ "openui-date-picker-renderer-floating-input-container-icon": isOpen })
		})]
	});
};
const FloatingDatePicker = (0, react.forwardRef)((_, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		className: (0, clsx.default)("openui-date-picker-renderer-floating-reference")
	}), (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref: floatingRef,
		style: {
			...floatingStyles,
		...
		className: (0, clsx.default)("openui-date-picker-renderer-floating-content", portalThemeClassName),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const FloatingDatePickerRenderer = ({ className, style }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref: containerRef,
		className: (0, clsx.default)("openui-date-picker-renderer-floating-container", className),
		style,
...
const FollowUpBlock = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-follow-up-block", className),
		style,
		...rest,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const FollowUpItem = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
		ref,
		className: (0, clsx.default)("openui-follow-up-item", className),
		...rest,
...
const FormControl = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-form-control", className),
		style,
...
const Hint = (0, react.forwardRef)(({ children, className, style, hasError, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-hint", className, { "openui-hint-error": resolvedHasError }),
		style,
		...props,
		children
	});
...
const Image = (0, react.forwardRef)((props, ref) => {
	...
	const image = /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
		...
		src,
		alt,
		className: (0, clsx.default)("openui-image", { [`${scaleMap[scale]}`]: scale }, className),
		style: styles,
		onError: (e) => {
...
const GalleryModal = ({ images, selectedImageIndex, setSelectedImageIndex, onClose }) => {
	...
	return (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-gallery__modal", portalThemeClassName),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						scrollButtons.showLeft && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: (0, clsx.default)("openui-gallery__modal-carousel-button-container", "openui-gallery__modal-carousel-button-container-left"),
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
								className: (0, clsx.default)("openui-gallery__carousel-button", "openui-gallery__carousel-button--left"),
								onClick: () => scroll("left"),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: images.map((image, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: (0, clsx.default)("openui-gallery__modal-thumbnail", index === selectedImageIndex && "openui-gallery__modal-thumbnail--active"),
						...
						scrollButtons.showRight && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							className: (0, clsx.default)("openui-gallery__modal-carousel-button-container", "openui-gallery__modal-carousel-button-container-right"),
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
								className: (0, clsx.default)("openui-gallery__carousel-button", "openui-gallery__carousel-button--right"),
								onClick: () => scroll("right"),
...
const ImageGallery = ({ images }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-gallery", layoutClass),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "openui-gallery__grid",
			children: [visibleImages.map((image, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: (0, clsx.default)("openui-gallery__image", index === 0 && "openui-gallery__image--main"),
...
const Input = react.default.forwardRef(({ className, styles, size = "medium", hasError, ...props }, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
		autoComplete: "off",
		ref,
		className: (0, clsx.default)("openui-input", sizes[size], className, { "openui-input-error": resolvedHasError }),
		style: styles,
		...props
	});
});
...
const Label = (0, react.forwardRef)(({ children, className, style, disabled, required, ...props }, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_label.Root, {
		ref,
		className: (0, clsx.default)("openui-label", { "openui-label-disabled": disabled }, className),
		style,
		...props,
...
const ListBlock = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-list-block", className),
		style,
...
const ListItem = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-list-item-wrapper", hasAction && "openui-list-item-wrapper-with-action", className),
		style,
		...rest,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-list-item", hasAction && "openui-list-item-clickable"),
			onClick,
			role: hasAction ? "button" : void 0,
			tabIndex: hasAction ? 0 : void 0,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: (0, clsx.default)("openui-list-item-indicator", !listHasSubtitle && "openui-list-item-indicator-no-subtitle", hasAction && "openui-list-item-indicator-clickable"),
				children: [
...
const Container$1 = ({ children, logoUrl, agentName, className, isOpen = false }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShellStoreProvider, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LayoutContextProvider, {
			layout: "tray",
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: (0, clsx.default)("openui-bottom-tray-container", {
...
const ConversationStarter$1 = ({ starters, className, variant = "short" }) => {
	...
	if (starters.length === 0) return null;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-bottom-tray-conversation-starter", `openui-bottom-tray-conversation-starter--${variant}`, className),
		children: starters.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStarterItem$1, {
			displayText: item.displayText,
			prompt: item.prompt,
			icon: item.icon,
			onClick: handleClick,
...
const ThreadItem = ({ title, isSelected, onSelect, onDelete }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-bottom-tray-thread-item", { "openui-bottom-tray-thread-item--selected": isSelected }),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
			className: "openui-bottom-tray-thread-item-title",
			onClick: onSelect,
			children: title
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dropdown_menu.Root, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dropdown_menu.Trigger, {
			asChild: true,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				className: "openui-bottom-tray-thread-item-menu-trigger",
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.EllipsisVerticalIcon, { size: 14 })
			})
			...
			align: "start",
			sideOffset: 4,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dropdown_menu.Item, {
				className: "openui-bottom-tray-thread-item-menu-action",
				onSelect: (e) => {
					e.stopPropagation();
					onDelete();
				},
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Trash2Icon, {
					size: 14,
...
const ThreadListContainer = () => {
	const threads = (0, _openuidev_react_headless.useThreadList)((s) => s.threads);
	const selectedThreadId = (0, _openuidev_react_headless.useThreadList)((s) => s.selectedThreadId);
	const loadThreads = (0, _openuidev_react_headless.useThreadList)((s) => s.loadThreads);
	const selectThread = (0, _openuidev_react_headless.useThreadList)((s) => s.selectThread);
	const deleteThread = (0, _openuidev_react_headless.useThreadList)((s) => s.deleteThread);
	(0, react.useEffect)(() => {
		loadThreads();
	}, []);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dropdown_menu.Root, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dropdown_menu.Trigger, {
		asChild: true,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
			icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.MenuIcon, { size: "1em" }),
			variant: "tertiary",
			"aria-label": "Thread list",
			className: "openui-bottom-tray-thread-list-trigger"
		})
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dropdown_menu.Portal, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dropdown_menu.Content, {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: [threads.map((thread) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThreadItem, {
				title: thread.title,
				isSelected: selectedThreadId === thread.id,
				onSelect: () => selectThread(thread.id),
				onDelete: () => deleteThread(thread.id)
			}, thread.id)), threads.length === 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const BottomTrayNewChatButton = () => {
	const switchToNewThread = (0, _openuidev_react_headless.useThreadList)((s) => s.switchToNewThread);
...
const Header = ({ className, rightChildren, onMinimize, hideMinimizeButton = false, hideNewChatButton = false, hideThreadListContainer = false }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-bottom-tray-header", className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				rightChildren,
				!hideThreadListContainer && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThreadListContainer, {}),
				!hideNewChatButton && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(BottomTrayNewChatButton, {}),
				!hideMinimizeButton && onMinimize && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
...
const Composer$1 = ({ className, placeholder = "Type your message..." }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-bottom-tray-thread-composer", className),
		onClick: (e) => {
			if (!e.target.closest("button, a, [role='button']")) inputRef.current?.focus();
		},
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const ThreadContainer$1 = ({ children, className }) => {
	const isLoadingMessages = (0, _openuidev_react_headless.useThread)((s) => s.isLoadingMessages);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-bottom-tray-thread-container", className),
		style: { visibility: isLoadingMessages ? "hidden" : void 0 },
		children: [children, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ArtifactOverlay, {})]
	});
};
const ScrollArea$1 = ({ children, className, scrollVariant = "user-message-anchor", userMessageSelector = ".openui-bottom-tray-thread-message-user" }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			ref,
			className: (0, clsx.default)("openui-bottom-tray-thread-scroll-area", { "openui-bottom-tray-thread-scroll-area--user-message-anchor": scrollVariant === "user-message-anchor" }, className),
			children
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-bottom-tray-thread-scroll-gradient" })]
	});
};
const AssistantMessageContainer$1 = ({ children, className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-bottom-tray-thread-message-assistant", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const UserMessageContainer$1 = ({ children, className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-bottom-tray-thread-message-user", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const RenderMessage$1 = (0, react.memo)(({ message, className, allMessages, assistantMessage: CustomAssistantMessage, userMessage: CustomUserMessage, isStreaming }) => {
	if (message.role === "tool") return null;
	if (message.role === "assistant") {
		if (CustomAssistantMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CustomAssistantMessage, {
			message,
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantMessageContainer$1, {
			className,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AssistantMessageContent$1, {
				message,
				allMessages
			})
		});
	...
	if (message.role === "user") {
		if (CustomUserMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CustomUserMessage, { message });
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserMessageContainer$1, {
			className,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(UserMessageContent$1, { message })
		});
	}
	return null;
});
...
const Messages$1 = ({ className, loader, assistantMessage, userMessage }) => {
	...
	const isRunning = (0, _openuidev_react_headless.useThread)((s) => s.isRunning);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-bottom-tray-thread-messages", className),
		children: [messages.map((message, i) => {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_openuidev_react_headless.MessageProvider, {
				message,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(RenderMessage$1, {
					message,
					allMessages: messages,
					assistantMessage,
					userMessage,
...
const Trigger = (0, react.forwardRef)(({ children, className, isOpen = false, "aria-label": ariaLabel = "Open chat", ...rest }, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		ref,
		className: (0, clsx.default)("openui-bottom-tray-trigger", { "openui-bottom-tray-trigger--open": isOpen }, className),
		"aria-label": ariaLabel,
		...rest,
		children: children || /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronDown, { size: 24 })
	});
});
//#endregion
...
const WelcomeScreen$1 = (props) => {
	...
	if ("children" in props && props.children) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-bottom-tray-welcome-screen", className),
		children: props.children
	});
	const { title, description, image } = props;
	const renderImage = () => {
		if (!image) return null;
		if (isImageUrl$1(image)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
			src: image.url,
			alt: title || "",
...
const CustomComposerAdapter = ({ composer: Composer }) => {
	const processMessage = (0, _openuidev_react_headless.useThread)((s) => s.processMessage);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Composer, {
		onSend: (message) => {
			processMessage({
				role: "user",
				content: message
		...
		onCancel: (0, _openuidev_react_headless.useThread)((s) => s.cancelMessage),
		isRunning: (0, _openuidev_react_headless.useThread)((s) => s.isRunning),
		isLoadingMessages: (0, _openuidev_react_headless.useThread)((s) => s.isLoadingMessages)
	});
};
//#endregion
...
const ShareThreadModal = (0, react.forwardRef)(({ title, trigger, generateLink, themeClassName }, _ref) => {
	...
	const renderActionButton = () => {
		if (isLoading) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Button, {
			...
			size: "medium",
			disabled: true,
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Loader2, { className: "openui-share-thread-modal__loading-icon" }), "Generating..."]
		});
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dialog.Root, {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Trigger, {
			asChild: true,
			children: trigger
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dialog.Portal, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_dialog.Overlay, { className: (0, clsx.default)("openui-share-thread-modal__overlay", themeClassName || portalThemeClassName) }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_dialog.Content, {
			className: (0, clsx.default)("openui-share-thread-modal__content", isMobile ? "openui-share-thread-modal__content--mobile" : "", themeClassName || portalThemeClassName),
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const useShareThread = ({ generateShareLink }) => {
	const { isRunning, isLoadingMessages, messages } = (0, _openuidev_react_headless.useThread)();
	const { selectedThreadId } = (0, _openuidev_react_headless.useThreadList)();
...
const Composer = ({ className, placeholder = "Type your query here" }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-thread-composer", className),
		onClick: (e) => {
			if (!e.target.closest("button, a, [role='button']")) inputRef.current?.focus();
		},
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const DesktopWelcomeComposer = ({ className, placeholder = "Type your query here" }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-shell-desktop-welcome-composer", className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
			ref: inputRef,
			value: textContent,
			onChange: (e) => setTextContent(e.target.value),
...
const Container = ({ children, logoUrl, agentName, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShellStoreProvider, {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(LayoutContextProvider, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				className: (0, clsx.default)("openui-shell-container", { "openui-shell-container--mobile": isMobile }, className),
				ref,
				children
			})
		})
...
const ConversationStarter = ({ starters, className, variant = "short" }) => {
	...
	if (starters.length === 0) return null;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-conversation-starter", `openui-shell-conversation-starter--${variant}`, className),
		children: starters.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStarterItem, {
			displayText: item.displayText,
			prompt: item.prompt,
			icon: item.icon,
			onClick: handleClick,
...
const MobileHeader = ({ className, rightChildren }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-shell-mobile-header", className),
		children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
				size: "medium",
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [rightChildren, /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
					size: "medium",
					icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Plus, { size: "1em" }),
					onClick: switchToNewThread,
					variant: "secondary"
				})]
			})
...
const NewChatButton = ({ className }) => {
	...
	if (!isSidebarOpen) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
		icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.SquarePen, { size: "1em" }),
		onClick: switchToNewThread,
		variant: "primary",
		size: "small",
		className: (0, clsx.default)("openui-shell-new-chat-button_collapsed", className)
	});
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
		className: (0, clsx.default)("openui-shell-new-chat-button", className),
		iconRight: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.Plus, {}),
		variant: "primary",
		size: "small",
		onClick: switchToNewThread,
		children: "New Chat"
...
const SidebarContainer = ({ children, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [isMobile && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-sidebar-container__overlay", { "openui-shell-sidebar-container__overlay--collapsed": !isSidebarOpen }),
		onClick: () => {
			setIsSidebarOpen(false);
		}
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-sidebar-container", {
...
const SidebarHeader = ({ children, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-shell-sidebar-header", { "openui-shell-sidebar-header--collapsed": !isSidebarOpen }, className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
					icon: isSidebarOpen ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ArrowLeftFromLine, { size: "1em" }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ArrowRightFromLine, { size: "1em" }),
					onClick: () => {
...
const SidebarContent = ({ children, className }) => {
	const { isSidebarOpen } = useShellStore((state) => ({ isSidebarOpen: state.isSidebarOpen }));
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-sidebar-content", className, { "openui-shell-sidebar-content--collapsed": !isSidebarOpen }),
		children
	});
};
const SidebarSeparator = () => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-shell-sidebar-separator" });
};
//#endregion
...
const ResizableSeparator = ({ onResize, onDragStart, onDragEnd, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-resizable-separator", className),
		onMouseDown: handleMouseDown,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-shell-resizable-separator__handle" })
	});
};
//#endregion
...
const useArtifactResize = ({ isArtifactActive, isMobile, setIsSidebarOpen }) => {
	...
	const artifactPanelRef = (0, react.useRef)(null);
	(0, react.useEffect)(() => {
		if (isMobile) return;
		if (isArtifactActive) {
			setIsSidebarOpen(false);
	...
	return {
		...
		artifactPanelRef,
		isDragging,
		handleResize: (0, react.useCallback)((clientX) => {
...
const ThreadContainer = ({ children, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-thread-container", className, { "openui-shell-thread-container--artifact-active": isArtifactActive }),
		style: { visibility: isLoadingMessages ? "hidden" : void 0 },
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				ref: chatPanelRef,
				className: (0, clsx.default)("openui-shell-thread-chat-panel", { "openui-shell-thread-chat-panel--animating": !isDragging }),
				children: [children, isMobile && /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ArtifactOverlay, {})]
			}), !isMobile && isArtifactActive && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ResizableSeparator, {
				onResize: handleResize,
				onDragStart: handleDragStart,
				onDragEnd: handleDragEnd
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				ref: artifactPanelRef,
				className: (0, clsx.default)("openui-shell-thread-artifact-panel", { "openui-shell-thread-artifact-panel--animating": !isDragging }),
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ArtifactPortalTarget, {})
			})] })]
		})
	});
...
const ScrollArea = ({ children, className, scrollVariant = "user-message-anchor", userMessageSelector }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			ref,
			className: (0, clsx.default)("openui-shell-thread-scroll-area", { "openui-shell-thread-scroll-area--user-message-anchor": scrollVariant === "user-message-anchor" }, className),
			children
		})
	});
};
const AssistantMessageContainer = ({ children, className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-shell-thread-message-assistant", className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
			src: logoUrl,
			alt: "Assistant",
...
const UserMessageContainer = ({ children, className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-thread-message-user", className),
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const RenderMessage = (0, react.memo)(({ message, className, allMessages, assistantMessage: CustomAssistantMessage, userMessage: CustomUserMessage, isStreaming }) => {
	if (message.role === "tool") return null;
	if (message.role === "assistant") {
		if (CustomAssistantMessage) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CustomAssistantMessage, {
			message,
...
const ThreadError = () => {
	const threadError = (0, _openuidev_react_headless.useThread)((s) => s.threadError);
...
const Messages = ({ className, loader, assistantMessage, userMessage }) => {
	...
	const threadError = (0, _openuidev_react_headless.useThread)((s) => s.threadError);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-shell-thread-messages", className),
		children: [
...
const ThreadHeader = ({ children, className }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-thread-header", className),
		children
	});
};
//#endregion
...
const ThreadButton = ({ id, title, className }) => {
	...
	const { layout } = useLayoutContext();
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-shell-thread-button", { "openui-shell-thread-button--selected": selectedThreadId === id }, className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
...
const ThreadList = ({ className }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-thread-list", className),
		children: Object.entries(groupedThreads).filter(([_, groupThreads]) => groupThreads.length > 0).map(([group, groupThreads]) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: "openui-shell-thread-list-group",
			children: groupLabels[group]
		}), groupThreads.map((thread) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThreadButton, {
			id: thread.id,
			title: thread.title
		}, thread.id))] }, group))
	});
...
const WelcomeScreen = (props) => {
	...
	if ("children" in props && props.children) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		className: (0, clsx.default)("openui-shell-welcome-screen", className),
		children: props.children
	});
	const { title, description, image } = props;
	const renderImage = () => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-shell-welcome-screen", "openui-shell-welcome-screen--with-composer", className),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DesktopWelcomeComposer, {})
...
const GenUIAssistantMessage = ({ message, library }) => {
	...
	const isRunning = (0, _openuidev_react_headless.useThread)((s) => s.isRunning);
	const processMessage = (0, _openuidev_react_headless.useThread)((s) => s.processMessage);
	const updateMessage = (0, _openuidev_react_headless.useThread)((s) => s.updateMessage);
	const isStreaming = (0, react.useMemo)(() => {
	...
	const { content: openuiCode, contextString } = (0, react.useMemo)(() => {
	...
	const toolMessages = (0, react.useMemo)(() => {
		const result = [];
	...
	const handleAction = (0, react.useCallback)((event) => {
		if (event.type === _openuidev_react_lang.BuiltinActionType.ContinueConversation) {
		...
		} else if (event.type === _openuidev_react_lang.BuiltinActionType.OpenUrl) {
			const url = event.params?.["url"];
			if (typeof window !== "undefined" && url) window.open(url, "_blank");
		}
	}, [processMessage]);
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(AssistantMessageContainer, { children: [(message.toolCalls && message.toolCalls.length > 0 || toolMessages.length > 0) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(BehindTheScenes, {
		isStreaming,
		toolCallsComplete: !!message.content,
		children: [message.toolCalls?.map((toolCall, idx) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToolCallComponent, {
			toolCall,
			isStreaming,
			toolsDone: !!message.content,
			isLast: idx === (message.toolCalls?.length ?? 0) - 1 && toolMessages.length === 0
		}, toolCall.id)), toolMessages.map((tm) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ToolResult, {
			message: tm,
			toolName: getToolName(tm.toolCallId)
		}, tm.id))]
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_openuidev_react_lang.Renderer, {
		response: openuiCode,
		library,
		isStreaming,
...
function withChatProvider(WrappedComponent) {
	const WithChatProvider = (props) => {
		...
		const genUIAssistantMessage = (0, react.useMemo)(() => {
			if (customAssistantMessage || !componentLibrary) return void 0;
			return ({ message }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GenUIAssistantMessage, {
				message,
				library: componentLibrary
			});
		}, [customAssistantMessage, componentLibrary]);
		const genUIUserMessage = (0, react.useMemo)(() => {
			if (customUserMessage || !componentLibrary) return void 0;
			return ({ message }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(GenUIUserMessage, { message });
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(disableThemeProvider ? DummyThemeProvider : ThemeProvider, {
			...theme,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_openuidev_react_headless.ChatProvider, {
				...chatProviderProps,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WrappedComponent, { ...innerProps })
			})
		});
	};
...
const WelcomeMessageRenderer$2 = ({ welcomeMessage }) => {
	...
	if (isWelcomeComponent(welcomeMessage)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeScreen$1, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(welcomeMessage, {}) });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeScreen$1, {
...
const ConversationStartersRenderer$2 = ({ conversationStarters }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStarter$1, {
...
const BottomTrayInner = ({ logoUrl = "https://www.openui.com/favicon.svg", agentName = "My Agent", messageLoading: MessageLoadingComponent = MessageLoading$2, scrollVariant = "user-message-anchor", isOpen: controlledIsOpen, onOpenChange, defaultOpen = false, welcomeMessage, conversationStarters, assistantMessage, userMessage, composer: ComposerComponent, headerActions, generateShareLink }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Trigger, {
		onClick: () => handleOpenChange(!isOpen),
		isOpen,
		children: logoUrl ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("img", {
			src: logoUrl,
			alt: "Logo",
			className: "openui-bottom-tray-trigger-logo"
		}) : null
	}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Container$1, {
		logoUrl,
		agentName,
		isOpen,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ThreadContainer$1, { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Header, {
				onMinimize: () => handleOpenChange(false),
				rightChildren: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [generateShareLink ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShareThread, { generateShareLink }) : null, headerActions] })
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeMessageRenderer$2, { welcomeMessage }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ScrollArea$1, {
				scrollVariant,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Messages$1, {
					loader: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MessageLoadingComponent, {}),
					assistantMessage,
					userMessage
				})
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStartersRenderer$2, { conversationStarters }),
			ComposerComponent ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CustomComposerAdapter, { composer: ComposerComponent }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Composer$1, {})
		] })
	})] });
};
...
const WelcomeMessageRenderer$1 = ({ welcomeMessage }) => {
	...
	if (isWelcomeComponent(welcomeMessage)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeScreen$2, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(welcomeMessage, {}) });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeScreen$2, {
		title: welcomeMessage.title,
		description: welcomeMessage.description,
		image: welcomeMessage.image
	});
...
const ConversationStartersRenderer$1 = ({ conversationStarters }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStarter$2, {
		variant: conversationStarters.variant,
		starters: conversationStarters.options
	});
};
const CopilotInner = ({ logoUrl = "https://www.openui.com/favicon.svg", agentName = "My Agent", messageLoading: MessageLoadingComponent = MessageLoading$3, scrollVariant = "user-message-anchor", welcomeMessage, conversationStarters, assistantMessage, userMessage, composer: ComposerComponent, headerActions, generateShareLink }) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Container$2, {
		logoUrl,
		agentName,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ThreadContainer$2, { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Header$1, { rightChildren: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [generateShareLink ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShareThread, { generateShareLink }) : null, headerActions] }) }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeMessageRenderer$1, { welcomeMessage }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ScrollArea$2, {
				scrollVariant,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Messages$2, {
					loader: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MessageLoadingComponent, {}),
					assistantMessage,
					userMessage
				})
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStartersRenderer$1, { conversationStarters }),
			ComposerComponent ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CustomComposerAdapter, { composer: ComposerComponent }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Composer$2, {})
		] })
	});
};
...
const WelcomeMessageRenderer = ({ welcomeMessage, conversationStarters }) => {
	...
	if (isWelcomeComponent(welcomeMessage)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeScreen, { children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(welcomeMessage, {}) });
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeScreen, {
		title: welcomeMessage.title,
		description: welcomeMessage.description,
		image: welcomeMessage.image,
		starters: conversationStarters?.options,
...
const ConversationStartersRenderer = ({ conversationStarters }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStarter, {
		variant: conversationStarters.variant,
		starters: conversationStarters.options
	});
};
const FullScreenInner = ({ logoUrl = "https://www.openui.com/favicon.svg", agentName = "My Agent", messageLoading: MessageLoadingComponent = MessageLoading$1, scrollVariant = "user-message-anchor", welcomeMessage, conversationStarters, assistantMessage, userMessage, composer: ComposerComponent, threadHeader, mobileHeaderActions, generateShareLink }) => {
	const shareButton = generateShareLink ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ShareThread, { generateShareLink }) : null;
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Container, {
		logoUrl,
		agentName,
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SidebarContainer, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SidebarHeader, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(SidebarContent, { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(NewChatButton, {}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(SidebarSeparator, {}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThreadList, {})
		] })] }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ThreadContainer, { children: [
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(MobileHeader, { rightChildren: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [shareButton, mobileHeaderActions] }) }),
			(threadHeader || shareButton) && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(ThreadHeader, { children: [threadHeader, shareButton] }),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(WelcomeMessageRenderer, {
				welcomeMessage,
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ConversationStartersRenderer, { conversationStarters }),
			ComposerComponent ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CustomComposerAdapter, { composer: ComposerComponent }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Composer, {})
		] })]
	});
};
...
const RadioGroup = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_radio_group.Root, {
		ref,
		className: (0, clsx.default)("openui-radio-group", variants$2[variant], className),
		style,
		...rest,
		children
	});
...
const RadioItem = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_radio_group.Item, {
			ref,
			id,
			className: (0, clsx.default)("openui-radio-item-root", className),
			value,
			disabled,
			required,
			style,
...
const FoldableSectionRoot = (0, react.forwardRef)(({ className, style, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Root, {
	ref,
	className: (0, clsx.default)("openui-foldable-section-root", className),
	style,
	...props
}));
...
const FoldableSectionItem = (0, react.forwardRef)(({ className, style, value, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Item, {
	ref,
	className: (0, clsx.default)("openui-foldable-section-item", className),
	style,
	value,
	...props
}));
...
const FoldableSectionTrigger = (0, react.forwardRef)(({ className, style, text, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Header, {
	...
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Trigger, {
		ref,
		className: (0, clsx.default)("openui-foldable-section-trigger", className),
		style,
		...props,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: "openui-foldable-section-trigger-content-wrapper",
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(Separator, { className: "openui-foldable-section-trigger-content-separator" }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: "openui-foldable-section-trigger-content-icon-button-wrapper",
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(IconButton, {
					icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(lucide_react.ChevronRight, { className: "openui-foldable-section-trigger-content-icon-button-icon" }),
					size: "3-extra-small",
					variant: "secondary",
...
const FoldableSectionContent = (0, react.forwardRef)(({ className, style, children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_accordion.Content, {
	ref,
	className: (0, clsx.default)("openui-foldable-section-content", className),
	style,
	...props,
	children
}));
		...
		if (isRange) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(react_jsx_runtime.Fragment, { children: valueToShow?.map((v, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_slider.Thumb, {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-slider-thumb-handle-inner-dot" })
	...
	const renderDots = () => {
		if (variant === "discrete" && step) {
			...
			return Array.from({ length: numSteps + 1 }, (_, index) => {
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					className: (0, clsx.default)("openui-slider-dots-dot", { "openui-slider-dots-dot--active": isActive }),
					style: { left: `${position}%` }
				}, value);
			});
		}
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					...
					children: /* @__PURE__ */ (0, react.createElement)(_radix_ui_react_slider.Root, {
						ref,
						className: (0, clsx.default)("openui-slider-root", { "openui-slider--disabled": disabled }, className),
						...props,
						min,
						max,
						step,
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_slider.Range, { className: (0, clsx.default)("openui-slider-range", { "openui-slider-range--at-min": !isRange && valueToShow?.[0] === min }) }), variant === "discrete" && renderDots()]
					}), thumbs)
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const ValueInput = ({ value, onChange, error, disabled }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Input, {
			...
			className: (0, clsx.default)("openui-slider-block__input", { "openui-slider-block__input-error": error }),
			disabled,
...
const SliderBlock = (props) => {
			...
			return isRange ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-slider-block__separator" }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Select, {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			className: (0, clsx.default)("openui-slider-block__header", { "openui-slider-block__header--with-error": hasError }),
			children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const StepsItem = ({ title, details, number }) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			...
			}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", { className: "openui-connector-line" })]
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const SwitchGroup = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-switch-group", variants$1[variant], className),
		style,
		children
	});
});
...
const SwitchItem = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_switch.Root, {
			...
			onCheckedChange: onChange,
			id,
			className: (0, clsx.default)("openui-switch-item-root", className),
			disabled,
			required,
			...rest,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_switch.Thumb, { className: "openui-switch-item-thumb" })
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const Tabs = (0, react.forwardRef)(({ className, style, variant = "clear", ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_tabs.Root, {
	ref,
	className: (0, clsx.default)("openui-tabs", tabsVariants[variant], className),
	style,
	...props
}));
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_tabs.List, {
				...
				className: (0, clsx.default)("openui-tabs-list", tabsListVariants[variant], className),
				style,
				...props
			}),
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const TabsTrigger = (0, react.forwardRef)(({ className, style, icon, text, subtext, image, value, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_radix_ui_react_tabs.Trigger, {
	ref,
	className: (0, clsx.default)("openui-tabs-trigger", className),
	style,
	value,
	...props,
	children: [
...
const TabsContent = (0, react.forwardRef)(({ className, style, children, ...props }, ref) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_radix_ui_react_tabs.Content, {
	ref,
	className: (0, clsx.default)("openui-tabs-content", className),
	style,
	...props,
	children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
...
const Tag = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		ref,
		className: (0, clsx.default)("openui-tag", sizeMap[size], variantMap$2[variant], className),
		style: styles,
		...rest,
		children: [icon && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
...
const TagBlock = (0, react.forwardRef)((props, ref) => {
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-tag-block", props.className),
		style: props.styles,
		children: props.children
	});
});
...
const TextArea = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
		ref,
		className: (0, clsx.default)("openui-textarea", className, { "openui-textarea-error": resolvedHasError }),
		...rest,
		rows
	});
});
...
const TextCallout = react.default.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		ref,
		className: (0, clsx.default)("openui-text-callout", variantMap$1[variant], className),
		...rest,
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
...
const CalloutSchema = zod_v4.z.object({
	...
	visible: (0, _openuidev_react_lang.reactive)(zod_v4.z.boolean().optional())
});
//#endregion
//#region src/genui-lib/Callout/index.tsx
const Callout$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Callout",
	props: CalloutSchema,
	description: "Callout banner. Optional visible is a reactive $boolean — auto-dismisses after 3s by setting $visible to false.",
	component: ({ props }) => {
		const field = (0, _openuidev_react_lang.useStateField)("visible", props.visible);
...
const CardHeader$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "CardHeader",
...
const CodeBlock$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "CodeBlock",
...
const Image$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Image",
	props: ImageSchema,
...
const ImageBlock$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "ImageBlock",
...
const ImageGallery$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "ImageGallery",
...
const MarkDownRenderer$1 = (0, _openuidev_react_lang.defineComponent)({
...
const Separator$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Separator",
...
const TextCallout$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "TextCallout",
...
const TextContent$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "TextContent",
	...
	component: ({ props }) => {
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			...
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(MarkDownRenderer, { textMarkdown: props.text == null ? "" : String(props.text) })
		});
	}
});
//#endregion
...
const Point = (0, _openuidev_react_lang.defineComponent)({
	name: "Point",
	props: PointSchema,
...
const ScatterSeries = (0, _openuidev_react_lang.defineComponent)({
	name: "ScatterSeries",
...
const Series = (0, _openuidev_react_lang.defineComponent)({
	name: "Series",
	props: SeriesSchema,
...
const Slice = (0, _openuidev_react_lang.defineComponent)({
	name: "Slice",
	props: SliceSchema,
...
const HorizontalBarChart$1 = (0, _openuidev_react_lang.defineComponent)({
	...
	component: ({ props }) => {
		...
		return react.default.createElement(HorizontalBarChart, {
			data,
...
const RadarChart$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "RadarChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(RadarChart, {
			data,
			categoryKey: "category",
			isAnimationActive: false
		});
...
const PieChart$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "PieChart",
	...
	component: ({ props }) => {
		...
		if (labels.length > 0 && values.length > 0) {
			...
			if (!data.length) return null;
			return react.default.createElement(PieChart, {
				data,
				categoryKey: "category",
				dataKey: "value",
				variant: props.variant,
		...
		if (sliceData.length) return react.default.createElement(PieChart, {
			data: sliceData,
			categoryKey: "category",
			dataKey: "value",
			variant: props.variant,
...
const RadialChart$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "RadialChart",
	...
	component: ({ props }) => {
		...
		if (labels.length > 0 && values.length > 0) {
			...
			if (!data.length) return null;
			return react.default.createElement(RadialChart, {
				data,
				categoryKey: "category",
				dataKey: "value",
				isAnimationActive: false
		...
		const sliceData = buildSliceData(props.labels);
		if (sliceData.length) return react.default.createElement(RadialChart, {
			data: sliceData,
			categoryKey: "category",
			dataKey: "value",
			isAnimationActive: false
...
const SingleStackedBarChart = (0, _openuidev_react_lang.defineComponent)({
	...
	component: ({ props }) => {
		...
		if (labels.length > 0 && values.length > 0) {
			...
			if (!data.length) return null;
			return react.default.createElement(SingleStackedBar, {
				data,
				categoryKey: "category",
				dataKey: "value"
			});
		...
		const sliceData = buildSliceData(props.labels);
		if (sliceData.length) return react.default.createElement(SingleStackedBar, {
			data: sliceData,
			categoryKey: "category",
			dataKey: "value"
		});
...
const ScatterChart$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "ScatterChart",
	...
	component: ({ props }) => {
		...
		if (!data.length) return null;
		return react.default.createElement(ScatterChart, {
			data,
			xAxisDataKey: "x",
			yAxisDataKey: "y",
			isAnimationActive: false
...
const AreaChartCondensed$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "AreaChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(AreaChartCondensed, {
			data,
			categoryKey: "category",
			variant: props.variant,
			xAxisLabel: props.xLabel,
...
const BarChartCondensed$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "BarChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(BarChartCondensed, {
			data,
			categoryKey: "category",
			variant: props.variant,
			xAxisLabel: props.xLabel,
...
const LineChartCondensed$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "LineChart",
	...
	component: ({ props }) => {
		...
		const data = buildChartData(props.labels, props.series);
		if (!data.length) return null;
		return react.default.createElement(LineChartCondensed, {
			data,
			categoryKey: "category",
			variant: props.variant,
			xAxisLabel: props.xLabel,
...
const Col = (0, _openuidev_react_lang.defineComponent)({
	name: "Col",
	props: ColSchema,
	description: "Column definition — holds label + data array",
	component: () => null
});
const Table$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Table",
...
const TagBlockSchema = zod_v4.z.object({ tags: zod_v4.z.array(zod_v4.z.string()) });
//#endregion
//#region src/genui-lib/TagBlock/index.tsx
const TagBlock$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "TagBlock",
	props: TagBlockSchema,
	description: "tags is an array of strings",
	component: ({ props }) => {
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TagBlock, { children: asArray(props.tags).map((tag, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Tag, { text: tag }, i)) });
	}
});
//#endregion
//#region src/genui-lib/Action/schema.ts
/** Shared action prop schema — shows as `ActionExpression` in prompt signatures. */
const actionPropSchema = zod_v4.z.any();
(0, _openuidev_react_lang.tagSchemaId)(actionPropSchema, "ActionExpression");
//#endregion
...
const Button$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Button",
	props: ButtonSchema,
	description: "Clickable button",
	component: ({ props }) => {
		const triggerAction = (0, _openuidev_react_lang.useTriggerAction)();
		const formName = (0, _openuidev_react_lang.useFormName)();
		const isStreaming = (0, _openuidev_react_lang.useIsStreaming)();
		const formValidation = (0, _openuidev_react_lang.useFormValidation)();
		...
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
			...
			onClick: () => {
				...
				if (formValidation && variant === "primary") {
					if (action?.steps) {
						if (action.steps.some((s) => s.type === _openuidev_react_lang.ACTION_STEPS.ToAssistant || s.type === _openuidev_react_lang.ACTION_STEPS.Run && s.refType === "mutation") && !formValidation.validateForm()) return;
...
const Buttons$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Buttons",
	props: ButtonsSchema,
...
function createCheckBoxGroupSchema(CheckBoxItem) {
	return zod_v4.z.object({
		...
		rules: rulesSchema,
		value: (0, _openuidev_react_lang.reactive)(zod_v4.z.record(zod_v4.z.string(), zod_v4.z.boolean()).optional())
	});
}
//#endregion
//#region src/genui-lib/CheckBoxGroup/index.tsx
const CheckBoxItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "CheckBoxItem",
	props: CheckBoxItemSchema,
	description: "",
	component: () => null
});
const CheckBoxGroup$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "CheckBoxGroup",
	...
	component: ({ props }) => {
		const isStreaming = (0, _openuidev_react_lang.useIsStreaming)();
		const formValidation = (0, _openuidev_react_lang.useFormValidation)();
		const field = (0, _openuidev_react_lang.useStateField)(props.name, props.value);
		const rules = react.default.useMemo(() => (0, _openuidev_react_lang.parseStructuredRules)(props.rules), [props.rules]);
...
const DatePickerSchema = zod_v4.z.object({
	...
	rules: rulesSchema,
	value: (0, _openuidev_react_lang.reactive)(zod_v4.z.unknown().optional())
});
//#endregion
//#region src/genui-lib/DatePicker/index.tsx
const DatePicker$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "DatePicker",
...
const InputSchema = zod_v4.z.object({
	...
	rules: rulesSchema,
	value: (0, _openuidev_react_lang.reactive)(zod_v4.z.string().optional())
});
//#endregion
//#region src/genui-lib/Input/index.tsx
const Input$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Input",
	props: InputSchema,
	description: "",
	component: ({ props }) => {
...
const RadioItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "RadioItem",
	props: RadioItemSchema,
	description: "",
	component: () => null
});
const RadioGroup$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "RadioGroup",
...
const SelectItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "SelectItem",
	props: SelectItemSchema,
	description: "Option for Select",
	component: () => null
});
const Select$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Select",
...
const SliderSchema = zod_v4.z.object({
	...
	rules: rulesSchema,
	value: (0, _openuidev_react_lang.reactive)(zod_v4.z.array(zod_v4.z.number()).optional())
});
//#endregion
//#region src/genui-lib/Slider/index.tsx
const Slider$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Slider",
	props: SliderSchema,
...
const TextArea$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "TextArea",
...
const FormControl$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "FormControl",
...
const Form = (0, _openuidev_react_lang.defineComponent)({
	name: "Form",
	props: FormSchema,
	description: "Form container with fields and explicit action buttons",
	component: ({ props, renderNode }) => {
		const formValidation = (0, _openuidev_react_lang.useCreateFormValidation)();
		const formName = props.name;
		return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_openuidev_react_lang.FormValidationContext.Provider, {
			value: formValidation,
			children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_openuidev_react_lang.FormNameContext.Provider, {
				value: formName,
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					role: "form",
					style: {
...
const StepsItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "StepsItem",
	props: StepsItemSchema,
	description: "title and details text for one step",
	component: () => null
});
const Steps$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Steps",
...
const FollowUpItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "FollowUpItem",
...
const FollowUpBlock$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "FollowUpBlock",
...
const ListItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "ListItem",
	props: zod_v4.z.object({
		title: zod_v4.z.string(),
		subtitle: zod_v4.z.string().optional(),
...
const ListBlock$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "ListBlock",
	props: zod_v4.z.object({
...
const SectionItem = (0, _openuidev_react_lang.defineComponent)({
	name: "SectionItem",
	props: zod_v4.z.object({
		value: zod_v4.z.string(),
...
const SectionBlock = (0, _openuidev_react_lang.defineComponent)({
	name: "SectionBlock",
	props: zod_v4.z.object({
...
const Carousel$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Carousel",
	props: zod_v4.z.object({
...
const Stack = (0, _openuidev_react_lang.defineComponent)({
	name: "Stack",
	props: StackSchema,
...
const TabItem = (0, _openuidev_react_lang.defineComponent)({
	name: "TabItem",
	props: TabItemSchema,
	description: "value is unique id, trigger is tab label, content is array of components",
	component: () => null
});
const Tabs$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Tabs",
...
const Card$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Card",
	props: CardSchema,
...
const Label$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Label",
	props: LabelSchema,
...
const SwitchItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "SwitchItem",
	props: SwitchItemSchema,
	description: "Individual switch toggle",
	component: () => null
});
const SwitchGroup$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "SwitchGroup",
...
const AccordionItem$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "AccordionItem",
	props: AccordionItemSchema,
	description: "value is unique id, trigger is section title",
	component: () => null
});
const Accordion$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Accordion",
...
const Tag$1 = (0, _openuidev_react_lang.defineComponent)({
	name: "Tag",
	props: TagSchema,
	description: "Styled tag/badge with optional icon and variant",
	component: ({ props }) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Tag, {
		text: props.text,
		size: props.size,
		variant: props.variant
	})
...
const Modal$1 = ({ title, open, onOpenChange, size = "md", children }) => {
	...
	if (!open) return null;
	return (0, react_dom.createPortal)(/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		className: (0, clsx.default)("openui-modal-root", portalThemeClassName),
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
			className: "openui-modal-overlay",
			onClick: handleClose
		}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
			ref: contentRef,
			className: (0, clsx.default)("openui-modal-content", sizeClass[size]),
			role: "dialog",
			"aria-modal": "true",
			"aria-label": title,
			tabIndex: -1,
...
const ModalSchema = zod_v4.z.object({
	title: zod_v4.z.string(),
	open: (0, _openuidev_react_lang.reactive)(zod_v4.z.boolean().optional()),
...
const Modal = (0, _openuidev_react_lang.defineComponent)({
	name: "Modal",
	props: ModalSchema,
	...
	component: ({ props, renderNode }) => {
		const field = (0, _openuidev_react_lang.useStateField)("open", props.open);
...
const openuiLibrary = (0, _openuidev_react_lang.createLibrary)({
	root: "Stack",
...
const ChatCard = (0, _openuidev_react_lang.defineComponent)({
	name: "Card",
	props: zod_v4.z.object({ children: zod_v4.z.array(ChatCardChildUnion) }),
...
const openuiChatLibrary = (0, _openuidev_react_lang.createLibrary)({
	root: "Card",
...
Object.defineProperty(exports, "CopilotShell", {
	enumerable: true,
	get: function() {
		return CopilotShell_exports;
	}
});
...
exports.openuiAdditionalRules = openuiAdditionalRules;
exports.openuiChatAdditionalRules = openuiChatAdditionalRules;
exports.openuiChatComponentGroups = openuiChatComponentGroups;
exports.openuiChatExamples = openuiChatExamples;
exports.openuiChatLibrary = openuiChatLibrary;
exports.openuiChatPromptOptions = openuiChatPromptOptions;
exports.openuiComponentGroups = openuiComponentGroups;
exports.openuiExamples = openuiExamples;
exports.openuiLibrary = openuiLibrary;
exports.openuiPromptOptions = openuiPromptOptions;
exports.swatchTokens = swatchTokens;
exports.transformScatterData = transformScatterData;
Object.defineProperty(exports, "useActiveArtifact", {
	enumerable: true,
	get: function() {
		return _openuidev_react_headless.useActiveArtifact;
	}
});
Object.defineProperty(exports, "useArtifact", {
	enumerable: true,
	get: function() {
		return _openuidev_react_headless.useArtifact;
	}
});
