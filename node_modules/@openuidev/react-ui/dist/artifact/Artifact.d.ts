...
import { type ArtifactPanelProps } from "../components/_shared/artifact";
/**
 ...
 * ```
 */
export declare function Artifact<P = Record<string, unknown>>(config: ArtifactConfig<P>): ComponentRenderer<P>;
