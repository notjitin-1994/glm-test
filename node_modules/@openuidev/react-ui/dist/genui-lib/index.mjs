import { ACTION_STEPS, FormNameContext, FormValidationContext, createLibrary, defineComponent, parseStructuredRules, reactive, tagSchemaId, useCreateFormValidation, useFormName, useFormValidation, useIsStreaming, useStateField, useTriggerAction } from "@openuidev/react-lang";
import React, { Children, cloneElement, createContext, createElement, forwardRef, isValidElement, memo, useCallback, useContext, useEffect, useId, useImperativeHandle, useLayoutEffect, useMemo, useRef, useState } from "react";
import clsx from "clsx";
import { Fragment, jsx, jsxs } from "react/jsx-runtime";
import ReactMarkdown from "react-markdown";
import { oneLight, vscDarkPlus } from "react-syntax-highlighter/dist/esm/styles/prism";
import { AlertCircle, Check, CheckCheck, ChevronDown, ChevronDownIcon, ChevronLeft, ChevronRight, ChevronUp, ChevronUpIcon, Copy, X } from "lucide-react";
...
const Callout$1 = React.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		ref,
		className: clsx("openui-callout", variantMap$7[variant], duration && "openui-callout-autodismiss", className),
		style: dismissStyle,
		...rest,
...
const ScrollableTable = React.forwardRef(({ className, containerClassName, containerStyle, children, ...tableProps }, ref) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		ref: wrapperRef,
		tabIndex: 0,
		children: [isScrollable && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx("div", {
...
createContext(null);
new Set(Object.keys(defaultLightTheme));
//#endregion
...
const Card$1 = React.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ jsx("div", {
		ref,
		className: clsx("openui-card", className, variantMap$6[variant], widthMap[width]),
		...rest,
		children
	});
});
...
const TextCallout$1 = React.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ jsx("div", {
		ref,
		className: clsx("openui-text-callout", variantMap$5[variant], className),
		...rest,
		children: /* @__PURE__ */ jsxs("div", {
...
const TextContent = defineComponent({
	...
	component: ({ props }) => {
		...
		return /* @__PURE__ */ jsx("div", {
			...
			children: /* @__PURE__ */ jsx(MarkDownRenderer$1, { textMarkdown: props.text == null ? "" : String(props.text) })
		});
	}
});
//#endregion
		...
		children: [
			shouldShowScrollControls && /* @__PURE__ */ jsxs("div", {
				...
				children: [showTitle && /* @__PURE__ */ jsxs("div", {
					...
					children: shouldShowScrollControls && /* @__PURE__ */ jsxs(Fragment, { children: [/* @__PURE__ */ jsx(IconButton, {
			...
			/* @__PURE__ */ jsx("div", {
				...
				}), index !== itemsToDisplay.length - 1 && separator && /* @__PURE__ */ jsx(Separator$1, { className: "openui-stacked-legend-separator" })] }, item.key))
			}),
...
const Tag$1 = forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ jsxs("div", {
		ref,
		className: clsx("openui-tag", sizeMap$1[size], variantMap$4[variant], className),
		style: styles,
		...rest,
		children: [icon && /* @__PURE__ */ jsx("span", {
...
const TagBlock = defineComponent({
	...
	component: ({ props }) => {
		return /* @__PURE__ */ jsx(TagBlock$1, { children: asArray(props.tags).map((tag, i) => /* @__PURE__ */ jsx(Tag$1, { text: tag }, i)) });
	}
});
//#endregion
...
const Buttons$1 = forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ jsx("div", {
		ref,
		className: clsx("openui-buttons", variantMap$3[variant], className),
		style,
		...rest,
		children
	});
...
const Button = defineComponent({
	...
	component: ({ props }) => {
		...
		return /* @__PURE__ */ jsx(Button$1, {
			variant: variantMap$2[props.variant] || "primary",
...
const CheckBoxGroup$1 = React.forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ jsx("div", {
		ref,
		className: clsx("openui-checkbox-group", variantMap$1[variant], className),
		style,
		children
	});
});
...
const RadioGroup$1 = forwardRef((props, ref) => {
	...
	return /* @__PURE__ */ jsx(Radio.Root, {
		ref,
		className: clsx("openui-radio-group", variants$1[variant], className),
		style,
		...rest,
		children
	});
...
const Slider$1 = forwardRef(({ variant, min, max, step, disabled, value, defaultValue, onValueChange, className, style, leftContent, rightContent, ...props }, ref) => {
	...
	const thumbs = useMemo(() => {
		...
		if (isRange) return /* @__PURE__ */ jsx(Fragment, { children: valueToShow?.map((v, i) => /* @__PURE__ */ jsx(SliderPrimitive.Thumb, {
...
const FoldableSectionTrigger = forwardRef(({ className, style, text, ...props }, ref) => /* @__PURE__ */ jsx(AccordionPrimitive.Header, {
	...
	children: /* @__PURE__ */ jsx(AccordionPrimitive.Trigger, {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx(Separator$1, { className: "openui-foldable-section-trigger-content-separator" }), /* @__PURE__ */ jsxs("div", {
...
const SectionBlock = defineComponent({
	...
	component: ({ props, renderNode }) => {
		...
		if (!isFoldable) return /* @__PURE__ */ jsx(Fragment, { children: items.map((item, index) => /* @__PURE__ */ jsx(SectionV2, {
...
const Tag = defineComponent({
	...
	component: ({ props }) => /* @__PURE__ */ jsx(Tag$1, {
		text: props.text,
		size: props.size,
		variant: props.variant
	})
...
//#endregion
export { openuiAdditionalRules, openuiChatAdditionalRules, openuiChatComponentGroups, openuiChatExamples, openuiChatLibrary, openuiChatPromptOptions, openuiComponentGroups, openuiExamples, openuiLibrary, openuiPromptOptions };
