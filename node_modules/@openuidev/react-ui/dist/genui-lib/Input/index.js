...
export const Input = defineComponent({
    ...
    component: ({ props }) => {
        ...
        return (_jsx(OpenUIInput, { id: field.name, name: field.name, placeholder: props.placeholder || "", type: props.type || "text", value: field.value ?? "", onFocus: () => formValidation?.clearFieldError(field.name), onChange: (e) => {
