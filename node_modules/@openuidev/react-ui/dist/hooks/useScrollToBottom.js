...
export const useScrollToBottom = ({ ref, lastMessage, scrollVariant, userMessageSelector = ".openui-shell-thread-message-user", isRunning, isLoadingMessages, }) => {
    ...
    const scrollToBottom = useCallback(() => {
        ...
        if (scrollVariant === "always") {
            ...
            if (lastUserMessageDiv &&
                ...
                const scrollPosition = lastUserMessageDiv.getBoundingClientRect().top -
    ...
    useEffect(() => {
        if ((isRunning && !hasUserScrolledWhenIsRunning.current) || // scroll to bottom if user hasn't scrolled when isRunning is true
