 ...
 */
export const ResizableSeparator = ({ onResize, onDragStart, onDragEnd, className, }) => {
    ...
    return (_jsx("div", { className: clsx("openui-shell-resizable-separator", className), onMouseDown: handleMouseDown, children: _jsx("div", { className: "openui-shell-resizable-separator__handle" }) }));
};
//# sourceMappingURL=ResizableSeparator.js.map