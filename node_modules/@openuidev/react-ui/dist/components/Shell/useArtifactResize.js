 ...
 */
export const useArtifactResize = ({ isArtifactActive, isMobile, setIsSidebarOpen, }) => {
    ...
    const handleResize = useCallback((clientX) => {
        if (!containerRef.current || !chatPanelRef.current)
            return;
...
//# sourceMappingURL=useArtifactResize.js.map