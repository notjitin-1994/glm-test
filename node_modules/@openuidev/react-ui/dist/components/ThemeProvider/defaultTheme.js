import { black, swatch, white, withAlpha } from "./swatches";
...
const getBrandBaseShade = (brandSwatch) => brandSwatch === "neutral" ||
    brandSwatch === "slate" ||
    brandSwatch === "gray" ||
    brandSwatch === "zinc" ||
    brandSwatch === "stone"
...
const createColorTheme = ({ mode, neutralSwatch, brandSwatch, }) => {
    ...
    const brandSolid = brandSwatch === "neutral"
        ? isDark
            ? swatch(neutral, 25)
            : swatch(neutral, 1000)
    ...
    const accentText = brandSwatch === "neutral"
        ? isDark
            ? swatch(neutral, 1000)
            : swatch(neutral, 25)
 ...
 */
export const defaultLightTheme = Object.freeze({
    ...lightColorTheme,
    ...layoutTheme,
    ...typographyTheme,
    ...lightEffectTheme,
 ...
 */
export const defaultDarkTheme = Object.freeze({
    ...darkColorTheme,
    ...layoutTheme,
    ...typographyTheme,
    ...darkEffectTheme,
