...
export declare const black = "oklch(0 0 0 / 1)";
/** Absolute white in oklch format. */
export declare const white = "oklch(1 0 89.876 / 1)";
/**
 ...
 * ```
 */
export declare const swatch: (name: SwatchName, shade: SwatchShade) => string;
/**
 * Resolve a flat token key (e.g. `"blue-600"`, `"black-a50"`) to its oklch
 * color value. Returns `""` for unknown tokens.
 */
export declare const swatchToken: (token: string) => string;
/** The complete flat map of all swatch tokens (base shades + alpha variants). */
export declare const swatchTokens: Record<string, string>;
export {};
