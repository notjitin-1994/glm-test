...
export declare const ScrollArea: ({ children, className, scrollVariant, userMessageSelector, }: {
    children?: React.ReactNode;
    className?: string;
    /**
...
export declare const RenderMessage: React.MemoExoticComponent<({ message, className, allMessages, assistantMessage: CustomAssistantMessage, userMessage: CustomUserMessage, isStreaming, }: {
    message: Message;
    className?: string;
    allMessages: Message[];
...
export declare const MessageLoading: () => import("react/jsx-runtime").JSX.Element;
export declare const Messages: ({ className, loader, assistantMessage, userMessage, }: {
    className?: string;
