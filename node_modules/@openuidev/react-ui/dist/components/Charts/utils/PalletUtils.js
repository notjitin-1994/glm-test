...
export const getPaletteKey = (palette) => {
    return Object.keys(colorPalettes).find((key) => colorPalettes[key] === palette);
};
export const getPaletteMap = () => {
    return colorPalettes;
};
export const getDistributedColors = (colors, dataLength) => {
...
export const useChartPalette = ({ chartThemeName, customPalette, themePaletteName, dataLength, }) => {
...
//# sourceMappingURL=PalletUtils.js.map