 ...
 */
export const getWidthOfData = (data, containerWidth) => {
    if (data.length === 0) {
 ...
 */
export const getWidthOfGroup = (data) => {
    if (data.length === 0)
        return 200; // Fallback
 ...
 */
export const getSnapPositions = (data) => {
    if (data.length === 0)
        return [0];
...
//# sourceMappingURL=AreaAndLineUtils.js.map