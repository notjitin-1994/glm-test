...
import { AreaChartCondensed } from "../AreaChartCondensed";
...
`,
        ...
        theme: {
            description: "Specifies the color palette for the chart's areas and tooltips. Ignored when customPalette is provided.",
            control: "select",
...
export const LargeDatasetWithSidebarTooltip = {
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    maxWidth: "700px",
                }, children: [_jsx("div", { style: { fontSize: "14px", marginBottom: "8px" }, children: _jsx("strong", { children: "\uD83C\uDFAF Sidebar Tooltip Demo" }) }), _jsxs("div", { style: { fontSize: "13px", color: "#1565c0", lineHeight: "1.6" }, children: ["This chart has ", _jsx("strong", { children: "15 data series" }), " (more than 10). ", _jsx("br", {}), _jsx("strong", { children: "\u2728 Click on any point" }), " in the chart to open the sidebar tooltip on the right side.", _jsx("br", {}), "The sidebar provides a scrollable list of all series values at that point, making it easy to view large datasets.", _jsx("br", {}), _jsx("em", { children: "\uD83D\uDCA1 Try hovering first (shows inline tooltip), then click to see the sidebar version!" })] })] }), _jsx(Card, { style: { width: "700px" }, children: _jsx(AreaChartCondensed, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
...
export const BigLabelsStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "700px" }, children: _jsx(AreaChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
...
export const MixedLengthsStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "500px" }, children: _jsx(AreaChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
...
export const MinimalDataStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "400px" }, children: _jsx(AreaChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    width: "600px",
                                ...
                                fontSize: "12px",
                                    ...
                                    } }), _jsx("span", { style: { fontFamily: "monospace" }, children: color })] }, index))) })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(AreaChartCondensed, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
...
export const ResponsiveBehaviorDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the left or right edges of the container to see how the chart adapts" }), _jsxs("div", { style: {
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(AreaChartCondensed, { ...args }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, left: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "w") }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, right: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "e") }), _jsxs("div", { style: {
                                position: "absolute",
                                bottom: 8,
                                right: 8,
...
//# sourceMappingURL=areaChartCondensed.stories.js.map