...
import { ActiveDot, cartesianGrid, CustomTooltipContent, DefaultLegend, SideBarTooltip, SVGXAxisTick, YAxisTick, } from "../shared";
...
const LineChartCondensedComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant: lineChartVariant = "natural", tickVariant = "singleLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height = CHART_HEIGHT, width, strokeWidth = 2, }) => {
    ...
    const yAxis = useMemo(() => {
        ...
        return (_jsx("div", { className: "openui-line-chart-condensed-y-axis-container", children: _jsxs(RechartsLineChart, { width: yAxisWidth, height: effectiveHeight, data: data, margin: {
                    top: chartMargin.top,
                    ...
                    right: 0,
                        ...
                        return (_jsx(Line, { dataKey: key, stroke: "transparent", strokeWidth: 0, dot: false, isAnimationActive: false }, `yaxis-line-chart-condensed-${key}`));
    ...
    return (_jsx(LabelTooltipProvider, { children: _jsx(SideBarTooltipProvider, { isSideBarTooltipOpen: isSideBarTooltipOpen, setIsSideBarTooltipOpen: setIsSideBarTooltipOpen, data: sideBarTooltipData, setData: setSideBarTooltipData, children: _jsxs("div", { className: clsx("openui-line-chart-condensed-container", className), "data-openui-chart": exportData, style: {
                    width: width ? `${width}px` : undefined,
                }, children: [yAxisLabel && (_jsx("div", { className: "openui-line-chart-condensed-y-axis-label", children: yAxisLabel })), _jsxs("div", { className: "openui-line-chart-condensed-container-inner", ref: containerRef, children: [yAxis, _jsx("div", { className: "openui-line-chart-condensed", ref: chartContainerRef, children: _jsx(ChartContainer, { config: chartConfig, style: { width: "100%", height: effectiveHeight }, rechartsProps: {
                                        width: "100%",
                                        height: "100%",
                                    }, children: _jsxs(RechartsLineChart, { accessibilityLayer: true, data: data, margin: chartMargin, onClick: onLineClick, children: [grid && cartesianGrid(), _jsx(XAxis, { dataKey: categoryKey, tickLine: false, axisLine: false, textAnchor: isAngled ? "end" : "middle", interval: "preserveStartEnd", minTickGap: 5, height: xAxisHeight, tick: _jsx(SVGXAxisTick, {}), angle: calculatedAngle, orientation: "bottom", padding: {
                                                    left: X_AXIS_PADDING,
                                                ...
                                                return (_jsx(Line, { dataKey: key, type: variant, stroke: color, strokeWidth: strokeWidth, dot: false, activeDot: _jsx(ActiveDot, {}, `active-dot-${key}-${id}`), isAnimationActive: isAnimationActive }, `line-${key}`));
                                            })] }, `line-chart-condensed-${id}`) }) }), isSideBarTooltipOpen && _jsx(SideBarTooltip, { height: effectiveHeight })] }), xAxisLabel && (_jsx("div", { className: "openui-line-chart-condensed-x-axis-label", children: xAxisLabel })), legend && (_jsx(DefaultLegend, { items: legendItems, containerWidth: effectiveWidth, isExpanded: isLegendExpanded, setIsExpanded: setIsLegendExpanded }))] }) }) }));
};
// Added React.memo for performance optimization to avoid unnecessary re-renders
export const LineChartCondensed = React.memo(LineChartCondensedComponent);
//# sourceMappingURL=LineChartCondensed.js.map