...
import { LineChartCondensed } from "../LineChartCondensed";
...
`,
        ...
        theme: {
            description: "Specifies the color palette for the chart's lines and tooltips. Ignored when customPalette is provided.",
            control: "select",
...
export const DataExplorer = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: {
                        ...
                        width: "600px",
                    }, children: [_jsx("strong", { children: "\uD83C\uDFF7\uFE0F Dataset Selection:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", flexWrap: "wrap", gap: "4px" }, children: [_jsx("button", { onClick: () => setSelectedDataType("default"), style: selectedDataType === "default" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Default (12 months)" }), _jsx("button", { onClick: () => setSelectedDataType("bigLabels"), style: selectedDataType === "bigLabels" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFF7\uFE0F Big Labels" }), _jsx("button", { onClick: () => setSelectedDataType("denseTimeline"), style: selectedDataType === "denseTimeline" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Dense Timeline (16)" }), _jsx("button", { onClick: () => setSelectedDataType("companyNames"), style: selectedDataType === "companyNames" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFE2 Company Names" }), _jsx("button", { onClick: () => setSelectedDataType("countryData"), style: selectedDataType === "countryData" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDF0D Country Names" }), _jsx("button", { onClick: () => setSelectedDataType("financialQuarters"), style: selectedDataType === "financialQuarters" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Financial Quarters" }), _jsx("button", { onClick: () => setSelectedDataType("mixedLengths"), style: selectedDataType === "mixedLengths" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD24 Mixed Lengths" }), _jsx("button", { onClick: () => setSelectedDataType("edgeCases"), style: selectedDataType === "edgeCases" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFAF Edge Cases" }), _jsx("button", { onClick: () => setSelectedDataType("minimal"), style: selectedDataType === "minimal" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCF1 Minimal (3 items)" })] }), _jsxs("div", { style: { marginTop: "12px" }, children: [_jsx("strong", { children: "\uD83D\uDCD0 Tick Variant:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", gap: "4px" }, children: [_jsx("button", { onClick: () => setTickVariant("singleLine"), style: tickVariant === "singleLine" ? activeButtonStyle : buttonStyle, children: "Horizontal Labels" }), _jsx("button", { onClick: () => setTickVariant("angled"), style: tickVariant === "angled" ? activeButtonStyle : buttonStyle, children: "Angled Labels" })] })] }), _jsxs("div", { style: { marginTop: "12px", fontSize: "12px", color: "#666", fontFamily: "monospace" }, children: [_jsxs("div", { children: [_jsx("strong", { children: "Current Dataset:" }), " ", selectedDataType] }), _jsxs("div", { children: [_jsx("strong", { children: "Items:" }), " ", currentData.length, " | ", _jsx("strong", { children: "Category Key:" }), " ", currentCategoryKey, " | ", _jsx("strong", { children: "Tick:" }), " ", tickVariant] })] })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(LineChartCondensed, { ...args, data: currentData, categoryKey: currentCategoryKey, tickVariant: tickVariant }) })] }));
    },
    parameters: {
        docs: {
            description: {
                story: "**🎛️ Interactive Explorer:** This story allows you to explore different datasets and tick variants interactively. Use the buttons to switch between:\n\n**Datasets:**\n- **Default**: Standard 12-month data\n- **Big Labels**: Extremely long category names\n- **Dense Timeline**: Many items with medium-length labels\n- **Company Names**: Real-world business names\n- **Country Names**: Geographic labels\n- **Financial Quarters**: Quarterly financial data\n- **Mixed Lengths**: Combination of short and long labels\n- **Edge Cases**: Extreme scenarios\n- **Minimal**: Baseline with 3 items\n\n**Tick Variants:**\n- **Horizontal Labels**: Standard single-line labels with collision detection\n- **Angled Labels**: Rotated labels for better space utilization",
            },
        },
    },
};
...
export const LargeDatasetWithSidebarTooltip = {
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    maxWidth: "700px",
                }, children: [_jsx("div", { style: { fontSize: "14px", marginBottom: "8px" }, children: _jsx("strong", { children: "\uD83C\uDFAF Sidebar Tooltip Demo" }) }), _jsxs("div", { style: { fontSize: "13px", color: "#1565c0", lineHeight: "1.6" }, children: ["This chart has ", _jsx("strong", { children: "15 data series" }), " (more than 10). ", _jsx("br", {}), _jsx("strong", { children: "\u2728 Click on any point" }), " in the chart to open the sidebar tooltip on the right side.", _jsx("br", {}), "The sidebar provides a scrollable list of all series values at that point, making it easy to view large datasets.", _jsx("br", {}), _jsx("em", { children: "\uD83D\uDCA1 Try hovering first (shows inline tooltip), then click to see the sidebar version!" })] })] }), _jsx(Card, { style: { width: "700px" }, children: _jsx(LineChartCondensed, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
...
export const BigLabelsStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "700px" }, children: _jsx(LineChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
 ...
 */
export const DenseTimelineStory = {
    name: "📅 Dense Timeline (Many Periods)",
    args: {
        data: dataVariations.denseTimeline,
        categoryKey: "period",
        theme: "sunset",
        variant: "natural",
        tickVariant: "angled",
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests how the chart handles many data points (16 periods) with medium-length labels. The angled tick variant provides better label visibility compared to horizontal labels.",
            },
        },
    },
};
...
export const CompanyNamesStory = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests with real-world company names that have varying lengths. Demonstrates how the chart handles business data with naturally occurring long labels.",
            },
        },
    },
};
 ...
 */
export const CountryDataStory = {
    name: "🌍 Country Names (Geographic Labels)",
    args: {
        data: dataVariations.countryData,
        categoryKey: "country",
        theme: "orchid",
        variant: "natural",
        tickVariant: "angled",
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests with official country names that include full formal names. Shows how geographic data with naturally long names is handled.",
            },
        },
    },
};
 ...
 */
export const MixedLengthsStory = {
    name: "🔤 Mixed Lengths (Varied Label Sizes)",
    args: {
        data: dataVariations.mixedLengths,
        categoryKey: "item",
        theme: "spectrum",
        variant: "linear",
        tickVariant: "singleLine",
    ...
    render: (args) => (_jsx(Card, { style: { width: "500px" }, children: _jsx(LineChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
                story: "Tests the chart's ability to handle a mix of very short and very long labels within the same dataset.",
            },
        },
    },
};
 ...
 */
export const EdgeCasesStory = {
    name: "🎯 Edge Cases (Extreme Scenarios)",
    args: {
        data: dataVariations.edgeCases,
        categoryKey: "name",
        theme: "ocean",
        variant: "step",
        tickVariant: "angled",
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests extreme edge cases with exceptionally long labels and minimal data points. Pushes the label handling system to its limits.",
            },
        },
    },
};
...
export const MinimalDataStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "400px" }, children: _jsx(LineChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
                story: "Baseline test with minimal data and standard-length labels. Provides a control case to compare against complex scenarios.",
            },
        },
    },
};
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    width: "600px",
                                ...
                                fontSize: "12px",
                                    ...
                                    } }), _jsx("span", { style: { fontFamily: "monospace" }, children: color })] }, index))) })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(LineChartCondensed, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
 ...
 */
export const StrokeWidthComparison = {
    name: "📏 Stroke Width Comparison",
    render: () => (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "24px" }, children: [_jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Thin Lines (1px)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Subtle, minimal visual weight" })] }), _jsx(LineChartCondensed, { data: dataVariations.default, categoryKey: "month", theme: "ocean", strokeWidth: 1, height: 180 })] }), _jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Default Lines (2px)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Balanced, standard weight" })] }), _jsx(LineChartCondensed, { data: dataVariations.default, categoryKey: "month", theme: "emerald", strokeWidth: 2, height: 180 })] }), _jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Thick Lines (4px)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Bold, high emphasis" })] }), _jsx(LineChartCondensed, { data: dataVariations.default, categoryKey: "month", theme: "sunset", strokeWidth: 4, height: 180 })] })] })),
    parameters: {
        docs: {
            description: {
                story: "**Side-by-side comparison** of stroke widths:\n\n- **1px**: Thin, subtle lines perfect for dense data or multiple overlapping series\n- **2px**: Default weight, balanced for most use cases\n- **4px**: Thick, bold lines for high emphasis or presentations\n\n**When to use each:**\n- Use **1px** for many overlapping series or subtle trends\n- Use **2px** (default) for general purpose visualization\n- Use **4px** for presentations or when emphasizing specific trends",
            },
        },
    },
};
...
export const ResponsiveBehaviorDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the left or right edges of the container to see how the chart adapts" }), _jsxs("div", { style: {
                                ...
                                fontSize: "12px",
                                color: "#1565c0",
                            }, children: [_jsx("strong", { children: "\uD83C\uDFAF Try This:" }), " Resize the container to see how angled labels adapt to available space."] })] }), _jsxs(Card, { style: {
                        position: "relative",
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(LineChartCondensed, { ...args }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, left: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "w") }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, right: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "e") }), _jsxs("div", { style: {
                                position: "absolute",
                                bottom: 8,
                                right: 8,
...
//# sourceMappingURL=lineChartCondensed.stories.js.map