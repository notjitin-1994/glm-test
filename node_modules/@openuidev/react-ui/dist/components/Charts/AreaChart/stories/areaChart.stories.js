...
`,
        ...
        theme: {
            description: "Specifies the color palette for the chart's areas, tooltips, and legend. Ignored when customPalette is provided.",
            control: "select",
...
export const DataExplorer = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: {
                        ...
                        width: "600px",
                    }, children: [_jsx("strong", { children: "\uD83C\uDFF7\uFE0F Label Collision Test Suite:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", flexWrap: "wrap", gap: "4px" }, children: [_jsx("button", { onClick: () => setSelectedDataType("default"), style: selectedDataType === "default" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Default (12 months)" }), _jsx("button", { onClick: () => setSelectedDataType("bigLabels"), style: selectedDataType === "bigLabels" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFF7\uFE0F Big Labels (Collision Test)" }), _jsx("button", { onClick: () => setSelectedDataType("denseTimeline"), style: selectedDataType === "denseTimeline" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Dense Timeline (16 periods)" }), _jsx("button", { onClick: () => setSelectedDataType("companyNames"), style: selectedDataType === "companyNames" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFE2 Company Names" }), _jsx("button", { onClick: () => setSelectedDataType("countryData"), style: selectedDataType === "countryData" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDF0D Country Names" }), _jsx("button", { onClick: () => setSelectedDataType("financialQuarters"), style: selectedDataType === "financialQuarters" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Financial Quarters" }), _jsx("button", { onClick: () => setSelectedDataType("mixedLengths"), style: selectedDataType === "mixedLengths" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD24 Mixed Lengths" }), _jsx("button", { onClick: () => setSelectedDataType("edgeCases"), style: selectedDataType === "edgeCases" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFAF Edge Cases" }), _jsx("button", { onClick: () => setSelectedDataType("minimal"), style: selectedDataType === "minimal" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCF1 Minimal (3 items)" }), _jsx("button", { onClick: () => setSelectedDataType("expandCollapseMarketing"), style: selectedDataType === "expandCollapseMarketing" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD04 Marketing Channels (12 items)" })] }), _jsxs("div", { style: { marginTop: "12px", fontSize: "12px", color: "#666", fontFamily: "monospace" }, children: [_jsxs("div", { children: [_jsx("strong", { children: "Current Dataset:" }), " ", selectedDataType] }), _jsxs("div", { children: [_jsx("strong", { children: "Items:" }), " ", currentData.length, " | ", _jsx("strong", { children: "Category Key:" }), " ", currentCategoryKey] }), _jsxs("div", { children: [_jsx("strong", { children: "Features:" }), " Auto-truncation, Collision Detection, Horizontal Offset"] })] })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(AreaChart, { ...args, data: currentData, categoryKey: currentCategoryKey }) })] }));
    },
    parameters: {
        docs: {
            description: {
                story: "**🏷️ Big Labels Focus:** This story specifically tests label collision detection and truncation scenarios. Use the buttons to switch between different data variations that stress-test the chart's ability to handle long category names.\n\n**Key Features:**\n- ✂️ **Auto-truncation** with ellipsis for long labels\n- 🔍 **Collision detection** prevents overlapping text\n- ↔️ **Horizontal offset** for better visual distribution\n- 🚫 **No angle rotation** - labels stay horizontal for readability\n\n**Test Cases:**\n- **Big Labels**: Extremely long category names that trigger truncation\n- **Dense Timeline**: Many items with medium-length labels\n- **Company Names**: Real-world business names with varying lengths\n- **Mixed Lengths**: Combination of short and long labels\n- **Edge Cases**: Extreme scenarios for boundary testing",
            },
        },
    },
};
...
export const BigLabelsStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "700px" }, children: _jsx(AreaChart, { ...args }) })),
    parameters: {
        docs: {
            description: {
                story: "Tests the chart's collision detection system with extremely long category names. Labels should be automatically truncated with ellipsis (...) to prevent overlapping.",
            },
        },
    },
};
...
export const DenseTimelineStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "500px" }, children: _jsx(AreaChart, { ...args }) })),
    parameters: {
        docs: {
            description: {
                story: "Tests how the chart handles many data points with medium-length period labels. The chart should enable horizontal scrolling and apply intelligent label truncation.",
            },
        },
    },
};
...
export const CountryDataStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "600px" }, children: _jsx(AreaChart, { ...args }) })),
    parameters: {
        docs: {
            description: {
                story: "Tests with official country names that include full formal names. Shows how geographic data with naturally long names is handled by the collision detection system.",
            },
        },
    },
};
...
export const MixedLengthsStory = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests the chart's ability to handle a mix of very short and very long labels within the same dataset. Demonstrates adaptive truncation behavior.",
            },
        },
    },
};
...
export const EdgeCasesStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "400px" }, children: _jsx(AreaChart, { ...args }) })),
    parameters: {
        docs: {
            description: {
                story: "Tests extreme edge cases with exceptionally long labels and minimal data points. Pushes the collision detection and truncation system to its limits.",
            },
        },
    },
};
...
export const MinimalDataStory = {
    ...
    parameters: {
        docs: {
            description: {
                story: "Baseline test with minimal data and standard-length labels. Provides a control case to compare against the big label scenarios.",
            },
        },
    },
};
 ...
 */
export const ExpandCollapseMarketingStory = {
    name: "🔄 Legend Expand/Collapse",
    args: {
        data: dataVariations.expandCollapseMarketing,
        categoryKey: "channel",
        theme: "vivid",
        variant: "natural",
        grid: true,
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests the legend expand/collapse functionality with 12 marketing channels that have long descriptive names. The legend should automatically show a 'Show More' button when items overflow the container width, allowing users to toggle between collapsed and expanded states.",
            },
        },
    },
};
...
export const ResponsiveBehaviorDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the edges or corners of the container below to see how the chart adapts" }), _jsxs("div", { style: {
                                padding: "12px",
                                backgroundColor: "#e3f2fd",
                                borderRadius: "6px",
                                fontSize: "12px",
                                color: "#1565c0",
                            }, children: [_jsx("strong", { children: "\uD83C\uDFAF Try This:" }), " Resize the container to see automatic label truncation and layout adjustments."] })] }), _jsxs(Card, { style: {
                        position: "relative",
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(AreaChart, { ...args }), _jsx("div", { style: { ...handleStyle, top: -2, left: 0, right: 0, height: 12, cursor: "ns-resize" }, onMouseDown: (e) => handleMouseDown(e, "n") }), _jsx("div", { style: {
                                ...handleStyle,
                                bottom: -2,
                                left: 0,
                                right: 0,
                                height: 12,
                                cursor: "ns-resize",
                            }, onMouseDown: (e) => handleMouseDown(e, "s") }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, left: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "w") }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, right: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "e") }), _jsx("div", { style: {
                                ...handleStyle,
                                top: -2,
                                left: -2,
                                width: 20,
                                ...
                                cursor: "nwse-resize",
                                borderRadius: "2px",
                            }, onMouseDown: (e) => handleMouseDown(e, "nw") }), _jsx("div", { style: {
                                ...handleStyle,
                                top: -2,
                                right: -2,
                                width: 20,
                                ...
                                cursor: "nesw-resize",
                                borderRadius: "2px",
                            }, onMouseDown: (e) => handleMouseDown(e, "ne") }), _jsx("div", { style: {
                                ...handleStyle,
                                bottom: -2,
                                right: -2,
                                width: 20,
                                ...
                                cursor: "nwse-resize",
                                borderRadius: "2px",
                            }, onMouseDown: (e) => handleMouseDown(e, "se") }), _jsxs("div", { style: {
                                position: "absolute",
                                bottom: 8,
                                right: 8,
                                ...
                                fontFamily: "monospace",
                                fontWeight: "500",
                            }, children: [dimensions.width, "px \u00D7", " ", typeof dimensions.height === "number" ? `${dimensions.height}px` : "auto"] })] })] }));
    },
};
