...
const AreaChartComponent = ({ data, categoryKey, theme = "ocean", customPalette, variant: areaChartVariant = "natural", tickVariant = "multiLine", grid = true, icons = {}, isAnimationActive = false, showYAxis = true, xAxisLabel, yAxisLabel, legend = true, className, height, width, }) => {
    ...
    const yAxis = useMemo(() => {
        ...
        return (_jsx("div", { className: "openui-area-chart-y-axis-container", children: _jsxs(RechartsAreaChart, { width: yAxisWidth, height: chartHeight, data: data, margin: {
                    top: 20,
                    ...
                    right: 0,
                        ...
                        return (_jsx(Area, { dataKey: key, type: variant, stroke: "none", fill: "transparent", fillOpacity: 0, stackId: "a" }, `y-axis-${key}`));
                    })] }, `y-axis-chart-${id}`) }));
    }, [showYAxis, chartHeight, data, dataKeys, variant, id, maxLabelHeight, yAxisWidth]);
    return (_jsx(LabelTooltipProvider, { children: _jsx(SideBarTooltipProvider, { isSideBarTooltipOpen: isSideBarTooltipOpen, setIsSideBarTooltipOpen: setIsSideBarTooltipOpen, data: sideBarTooltipData, setData: setSideBarTooltipData, children: _jsxs("div", { className: clsx("openui-area-chart-container", className), "data-openui-chart": exportData, style: {
                    width: width ? `${width}px` : undefined,
                }, children: [_jsxs("div", { className: "openui-area-chart-container-inner", ref: chartContainerRef, children: [yAxis, _jsx("div", { className: "openui-area-chart-main-container", ref: mainContainerRef, children: _jsx(ChartContainer, { config: chartConfig, style: { width: dataWidth, minWidth: "100%", height: chartHeight }, rechartsProps: {
                                        width: "100%",
                                        height: "100%",
                                        minHeight: 1,
                                        minWidth: 1,
                                        initialDimension: { width: 1, height: 1 },
                                    }, children: _jsxs(RechartsAreaChart, { accessibilityLayer: true, data: data, margin: {
                                            top: 20,
                                            bottom: CHART_CONTAINER_BOTTOM_MARGIN,
                                        }, onClick: onAreaClick, children: [grid && cartesianGrid(), _jsx(XAxis, { dataKey: categoryKey, tickLine: false, axisLine: false, textAnchor: "middle", interval: 0, height: maxLabelHeight, tick: _jsx(XAxisTick, { variant: tickVariant, widthOfGroup: widthOfGroup, labelHeight: maxLabelHeight }), orientation: "bottom", padding: {
                                                    left: X_AXIS_PADDING,
