...
export const MINI_ELEMENT_SPACING = 10;
const CONTAINER_HORIZONTAL_PADDING = 8; // 4px left + 4px right
/**
 ...
 */
export const getPadding = (data, containerWidth) => {
 ...
 */
export const getRecentDataThatFits = (data, containerWidth) => {
...
//# sourceMappingURL=miniBarChartUtils.js.map