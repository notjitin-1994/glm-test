...
import { Calendar, Globe, Laptop, Monitor, Smartphone, TabletSmartphone, Tv, Watch, } from "lucide-react";
import { useState } from "react";
import { Card } from "../../../Card";
import { BarChartCondensed } from "../BarChartCondensed";
...
`,
        ...
        categoryKey: {
            description: "**Required.** The key in your data object that represents the category for the X-axis.",
            control: false,
            table: {
                type: { summary: "string" },
                category: "📊 Data Configuration",
        ...
        theme: {
            description: "Specifies the color palette for the chart's bars and tooltips. Ignored when customPalette is provided.",
            control: "select",
        ...
        customPalette: {
            description: "Custom array of colors to use instead of the theme palette. Overrides the theme prop when provided.",
            control: "object",
            table: {
                type: { summary: "string[]" },
                category: "🎨 Visual Styling",
        ...
        variant: {
            description: "Defines how multiple data series are displayed: `grouped` (side-by-side) or `stacked` (on top of each other).",
            control: "radio",
        ...
        tickVariant: {
            description: "X-axis tick label style. Choose between 'singleLine' (horizontal) or 'angled' (rotated at optimal angle).",
            control: "radio",
        ...
        icons: {
            description: "An object mapping data series keys to React components to be used as icons in the legend.",
            control: false,
            table: {
...
export const DataExplorer = {
    ...
    render: (args) => {
        const [selectedDataType, setSelectedDataType] = useState("default");
        const [variant, setVariant] = useState("grouped");
        const [tickVariant, setTickVariant] = useState("singleLine");
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: {
                        ...
                        width: "600px",
                    }, children: [_jsx("strong", { children: "\uD83C\uDFF7\uFE0F Dataset Selection:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", flexWrap: "wrap", gap: "4px" }, children: [_jsx("button", { onClick: () => setSelectedDataType("default"), style: selectedDataType === "default" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Default (12 months)" }), _jsx("button", { onClick: () => setSelectedDataType("bigLabels"), style: selectedDataType === "bigLabels" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFF7\uFE0F Big Labels" }), _jsx("button", { onClick: () => setSelectedDataType("companyNames"), style: selectedDataType === "companyNames" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFE2 Company Names" }), _jsx("button", { onClick: () => setSelectedDataType("financialQuarters"), style: selectedDataType === "financialQuarters" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Financial Quarters" }), _jsx("button", { onClick: () => setSelectedDataType("minimal"), style: selectedDataType === "minimal" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCF1 Minimal (3 items)" }), _jsx("button", { onClick: () => setSelectedDataType("weeklyTraffic"), style: selectedDataType === "weeklyTraffic" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCCA Weekly Traffic" })] }), _jsxs("div", { style: { marginTop: "12px" }, children: [_jsx("strong", { children: "\uD83D\uDCCA Chart Variant:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", gap: "4px" }, children: [_jsx("button", { onClick: () => setVariant("grouped"), style: variant === "grouped" ? activeButtonStyle : buttonStyle, children: "Grouped (Side-by-side)" }), _jsx("button", { onClick: () => setVariant("stacked"), style: variant === "stacked" ? activeButtonStyle : buttonStyle, children: "Stacked (On top)" })] })] }), _jsxs("div", { style: { marginTop: "12px" }, children: [_jsx("strong", { children: "\uD83D\uDCD0 Tick Variant:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", gap: "4px" }, children: [_jsx("button", { onClick: () => setTickVariant("singleLine"), style: tickVariant === "singleLine" ? activeButtonStyle : buttonStyle, children: "Horizontal Labels" }), _jsx("button", { onClick: () => setTickVariant("angled"), style: tickVariant === "angled" ? activeButtonStyle : buttonStyle, children: "Angled Labels" })] })] }), _jsxs("div", { style: { marginTop: "12px", fontSize: "12px", color: "#666", fontFamily: "monospace" }, children: [_jsxs("div", { children: [_jsx("strong", { children: "Current Dataset:" }), " ", selectedDataType] }), _jsxs("div", { children: [_jsx("strong", { children: "Items:" }), " ", currentData.length, " | ", _jsx("strong", { children: "Category Key:" }), " ", currentCategoryKey, " | ", _jsx("strong", { children: "Variant:" }), " ", variant, " | ", _jsx("strong", { children: "Tick:" }), " ", tickVariant] })] })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(BarChartCondensed, { ...args, data: currentData, categoryKey: currentCategoryKey, variant: variant, tickVariant: tickVariant }) })] }));
    },
    parameters: {
        docs: {
            description: {
                story: "**🎛️ Interactive Explorer:** This story allows you to explore different datasets, chart variants, and tick variants interactively. Use the buttons to switch between:\n\n**Datasets:**\n- **Default**: Standard 12-month data\n- **Big Labels**: Extremely long category names\n- **Company Names**: Real-world business names\n- **Financial Quarters**: Quarterly financial data\n- **Minimal**: Baseline with 3 items\n- **Weekly Traffic**: 7-day traffic data\n\n**Chart Variants:**\n- **Grouped**: Bars side-by-side for comparison\n- **Stacked**: Bars stacked to show totals\n\n**Tick Variants:**\n- **Horizontal Labels**: Standard single-line labels with collision detection\n- **Angled Labels**: Rotated labels for better space utilization",
            },
        },
    },
};
 ...
 */
export const LargeDatasetWithSidebarTooltip = {
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    marginBottom: "16px",
                    padding: "16px",
                    background: "#e3f2fd",
                    borderRadius: "8px",
                    ...
                    maxWidth: "700px",
                }, children: [_jsx("div", { style: { fontSize: "14px", marginBottom: "8px" }, children: _jsx("strong", { children: "\uD83C\uDFAF Sidebar Tooltip Demo" }) }), _jsxs("div", { style: { fontSize: "13px", color: "#1565c0", lineHeight: "1.6" }, children: ["This chart has ", _jsx("strong", { children: "15 data series" }), " (more than 10). ", _jsx("br", {}), _jsx("strong", { children: "\u2728 Click on any bar" }), " in the chart to open the sidebar tooltip on the right side.", _jsx("br", {}), "The sidebar provides a scrollable list of all series values at that quarter, making it easy to view large datasets.", _jsx("br", {}), _jsx("em", { children: "\uD83D\uDCA1 Try hovering first (shows inline tooltip), then click to see the sidebar version!" })] })] }), _jsx(Card, { style: { width: "700px" }, children: _jsx(BarChartCondensed, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
                story: "**🎯 Large Dataset Handling:** When your chart has more than 10 data series, the inline tooltip becomes too crowded. This story demonstrates the sidebar tooltip feature:\n\n**Features:**\n- **15 data series** to showcase the sidebar tooltip\n- **Click interaction:** Click any bar to open the sidebar\n- **Scrollable view:** All series values in an organized, scrollable list\n- **Better UX:** Cleaner way to view many data points simultaneously\n- **Color-coded:** Each series maintains its color for easy identification\n- **Works with both variants:** Try switching between grouped and stacked variants\n\n**Usage:**\n1. Hover over the chart to see the inline tooltip (works for smaller datasets)\n2. Click on any bar to open the sidebar tooltip\n3. Scroll through all 15 series values\n4. Click outside or on the X button to close the sidebar",
            },
        },
    },
};
...
export const VariantComparison = {
    ...
    render: () => (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "24px" }, children: [_jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Grouped Variant (Side-by-side)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Best for comparing individual values across categories" })] }), _jsx(BarChartCondensed, { data: dataVariations.default, categoryKey: "month", variant: "grouped", theme: "ocean", height: 200 })] }), _jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Stacked Variant (On top of each other)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Best for showing how parts contribute to a total" })] }), _jsx(BarChartCondensed, { data: dataVariations.default, categoryKey: "month", variant: "stacked", theme: "emerald", height: 200 })] })] })),
    parameters: {
        docs: {
            description: {
                story: "**Side-by-side comparison** of chart variants:\n\n- **Grouped**: Bars are placed side-by-side within each category. Perfect for comparing individual values across different categories.\n- **Stacked**: Bars are stacked on top of each other to show how parts contribute to a total. Great for showing composition and totals simultaneously.\n\n**When to use each:**\n- Use **grouped** when you want to compare individual series values\n- Use **stacked** when you want to emphasize totals and part-to-whole relationships",
            },
        },
    },
};
...
export const BigLabelsStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "700px" }, children: _jsx(BarChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
                story: "Tests the chart with extremely long category names. The angled tick variant automatically rotates labels at an optimal angle to prevent overlapping and maximize readability.",
            },
        },
    },
};
 ...
 */
export const CompanyNamesStory = {
    name: "🏢 Company Names (Big Numbers)",
    args: {
        data: dataVariations.companyNames,
        categoryKey: "company",
        theme: "vivid",
        variant: "grouped",
        tickVariant: "angled",
    ...
    parameters: {
        docs: {
            description: {
                story: "Tests with real-world company names and very large numbers (billions and trillions). The Y-axis should format numbers with appropriate suffixes (B, T).",
            },
        },
    },
};
 ...
 */
export const FinancialQuartersGrouped = {
    name: "📈 Financial Quarters (Grouped)",
    args: {
        data: dataVariations.financialQuarters,
        categoryKey: "quarter",
        theme: "sunset",
        variant: "grouped",
        tickVariant: "singleLine",
    ...
    render: (args) => (_jsx(Card, { style: { width: "600px" }, children: _jsx(BarChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
 ...
 */
export const FinancialQuartersStacked = {
 ...
 */
export const WeeklyTrafficStory = {
    name: "📊 Weekly Traffic Analytics",
    args: {
        data: dataVariations.weeklyTraffic,
        categoryKey: "day",
        theme: "spectrum",
        variant: "grouped",
        tickVariant: "singleLine",
    ...
    render: (args) => (_jsx(Card, { style: { width: "650px" }, children: _jsx(BarChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
...
export const MinimalDataStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "400px" }, children: _jsx(BarChartCondensed, { ...args }) })),
    parameters: {
        docs: {
            description: {
 ...
 */
export const CustomPaletteStory = {
    name: "🎨 Custom Palette",
    args: {
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    border: "1px solid #e9ecef",
                    width: "600px",
                }, children: [_jsx("h4", { style: { margin: "0 0 8px 0", color: "#333" }, children: "\uD83C\uDFA8 Custom Color Palette" }), _jsx("p", { style: { margin: "0 0 12px 0", fontSize: "14px", color: "#666" }, children: "This chart uses a custom color palette instead of the default theme colors." }), _jsx("div", { style: { display: "flex", gap: "8px", flexWrap: "wrap" }, children: args.customPalette?.map((color, index) => (_jsxs("div", { style: {
                                display: "flex",
                                alignItems: "center",
                                gap: "4px",
                                padding: "4px 8px",
                                ...
                                fontSize: "12px",
                                    ...
                                    } }), _jsx("span", { style: { fontFamily: "monospace" }, children: color })] }, index))) })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(BarChartCondensed, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
                story: 'Demonstrates how to use the `customPalette` prop to provide your own color scheme. When `customPalette` is provided, it overrides the `theme` prop.\n\n**Usage:**\n```tsx\n<BarChartCondensed\n  data={data}\n  categoryKey="month"\n  customPalette={["#FF6B6B", "#4ECDC4", "#45B7D1"]}\n/>\n```',
            },
        },
    },
};
...
export const RadiusComparison = {
    ...
    render: () => (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "24px" }, children: [_jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Sharp Corners (0px)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "No rounding, clean angular look" })] }), _jsx(BarChartCondensed, { data: dataVariations.default, categoryKey: "month", variant: "grouped", theme: "ocean", radius: 0, height: 180 })] }), _jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Default Radius (4px)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Subtle rounding, balanced look" })] }), _jsx(BarChartCondensed, { data: dataVariations.default, categoryKey: "month", variant: "grouped", theme: "emerald", radius: 4, height: 180 })] }), _jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Rounded Corners (8px)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "More pronounced rounding" })] }), _jsx(BarChartCondensed, { data: dataVariations.default, categoryKey: "month", variant: "grouped", theme: "sunset", radius: 8, height: 180 })] })] })),
    parameters: {
        docs: {
            description: {
                story: "**Radius comparison** showing different corner radius values:\n\n- **0px**: Sharp, angular corners for a clean, modern look\n- **4px**: Default subtle rounding, balanced appearance\n- **8px**: More pronounced rounding for a softer appearance\n\n**When to use each:**\n- Use **0px** for a clean, technical, or minimalist aesthetic\n- Use **4px** (default) for general purpose use\n- Use **8px** for a friendlier, more approachable design",
            },
        },
    },
};
 ...
 */
export const TickVariantComparison = {
    name: "📐 Tick Variant Comparison",
    render: () => (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "24px" }, children: [_jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Single Line Variant (Horizontal)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Standard horizontal labels. Recharts automatically hides overlapping labels." })] }), _jsx(BarChartCondensed, { data: dataVariations.bigLabels, categoryKey: "category", variant: "grouped", tickVariant: "singleLine", theme: "ocean", height: 200 })] }), _jsxs(Card, { style: { width: "700px", padding: "16px" }, children: [_jsxs("div", { style: { marginBottom: "12px" }, children: [_jsx("div", { style: { fontSize: "16px", fontWeight: "600", marginBottom: "4px" }, children: "Angled Variant (Rotated)" }), _jsx("div", { style: { fontSize: "13px", color: "#666" }, children: "Automatically rotates labels at an optimal angle. Shows more labels without collision." })] }), _jsx(BarChartCondensed, { data: dataVariations.bigLabels, categoryKey: "category", variant: "grouped", tickVariant: "angled", theme: "emerald", height: 260 })] })] })),
    parameters: {
        docs: {
            description: {
                story: "**Side-by-side comparison** of tick variants:\n\n- **Single Line**: Standard horizontal labels with automatic collision detection. Recharts hides overlapping labels.\n- **Angled**: Rotates labels at an optimal angle calculated based on label width and available space. Shows more labels without collision.\n\n**When to use each:**\n- Use **singleLine** for short labels or when you have few data points\n- Use **angled** for long labels or many data points where horizontal labels would overlap",
            },
        },
    },
};
 ...
 */
export const SuperCondensedStory = {
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    border: "1px solid #e9ecef",
                    width: "320px",
                }, children: [_jsx("h4", { style: { margin: "0 0 8px 0", color: "#333" }, children: "\uD83D\uDD2C Ultra Condensed View" }), _jsx("p", { style: { margin: "0 0 12px 0", fontSize: "14px", color: "#666" }, children: "24 months \u00D7 3 series = 72 bars in 320px width. Each bar is ~4px wide or less!" }), _jsxs("ul", { style: { margin: "0", paddingLeft: "20px", fontSize: "12px", color: "#666" }, children: [_jsxs("li", { children: ["Bars ", "<", " 7px wide = no rounded corners"] }), _jsx("li", { children: "Minimum bar width: 2px enforced" }), _jsx("li", { children: "Angled labels prevent overlap" }), _jsx("li", { children: "Internal lines hidden on thin bars" })] })] }), _jsx(Card, { style: { width: "320px" }, children: _jsx(BarChartCondensed, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
                story: "**Extreme density test** with 24 data points × 3 series (72 total bars) in a 320px container, making each bar approximately 4px wide or less. This demonstrates:\n\n- **Automatic corner removal**: Bars thinner than 7px automatically become square (no rounded corners)\n- **Minimum width enforcement**: Bars maintain a minimum width of 2px for visibility\n- **Grouped bar handling**: Multiple series create even thinner individual bars\n- **Label handling**: Angled labels prevent overlap in ultra-dense scenarios\n- **Internal line hiding**: The internal line is hidden when bars are too thin to display it properly\n\nThis represents an extreme edge case useful for:\n- Compact dashboard widgets\n- Sidebar sparkline-style analytics\n- Mobile-optimized views\n- High-density data visualization in limited space",
            },
        },
    },
};
 ...
 */
export const ResponsiveBehaviorDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the left or right edges of the container to see how the chart adapts" }), _jsxs("div", { style: {
                                padding: "12px",
                                backgroundColor: "#e3f2fd",
                                borderRadius: "6px",
                                fontSize: "12px",
                                color: "#1565c0",
                            }, children: [_jsx("strong", { children: "\uD83C\uDFAF Try This:" }), " Resize the container to see how bar widths and labels adapt to available space."] })] }), _jsxs(Card, { style: {
                        position: "relative",
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(BarChartCondensed, { ...args }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, left: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "w") }), _jsx("div", { style: { ...handleStyle, top: 0, bottom: 0, right: -2, width: 12, cursor: "ew-resize" }, onMouseDown: (e) => handleMouseDown(e, "e") }), _jsxs("div", { style: {
                                position: "absolute",
                                bottom: 8,
                                right: 8,
 ...
 */
export const BarWidthPlayground = {
    render: () => {
        const [variant, setVariant] = useState("grouped");
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs(Card, { style: { marginBottom: "24px", padding: "20px" }, children: [_jsx("h3", { style: { marginTop: 0, marginBottom: "20px", fontSize: "18px", fontWeight: 600 }, children: "\uD83C\uDF9B\uFE0F Bar Width Controls" }), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }, children: [_jsxs("div", { children: [_jsx("label", { style: { display: "block", marginBottom: "8px", fontWeight: 500 }, children: "Chart Variant" }), _jsxs("div", { style: { display: "flex", gap: "8px" }, children: [_jsx("button", { onClick: () => setVariant("grouped"), style: {
                                                        padding: "8px 16px",
                                                        borderRadius: "6px",
                                                        border: "1px solid",
                                                        ...
                                                        cursor: "pointer",
                                                        fontWeight: 500,
                                                    }, children: "Grouped" }), _jsx("button", { onClick: () => setVariant("stacked"), style: {
                                                        padding: "8px 16px",
                                                        borderRadius: "6px",
                                                        border: "1px solid",
                                                        ...
                                                        cursor: "pointer",
                                                        fontWeight: 500,
                                                    }, children: "Stacked" })] })] }), _jsxs("div", { children: [_jsx("label", { style: { display: "block", marginBottom: "8px", fontWeight: 500 }, children: "Number of Data Points" }), _jsxs("select", { value: dataSize, onChange: (e) => setDataSize(e.target.value), style: {
                                                width: "100%",
                                                padding: "8px 12px",
                                                borderRadius: "6px",
                                                border: "1px solid #e5e7eb",
                                                fontSize: "14px",
                                            }, children: [_jsx("option", { value: "small", children: "Small (4 points)" }), _jsx("option", { value: "medium", children: "Medium (12 points)" }), _jsx("option", { value: "large", children: "Large (24 points)" }), _jsx("option", { value: "xlarge", children: "X-Large (50 points)" })] })] }), _jsxs("div", { style: { gridColumn: "1 / -1" }, children: [_jsxs("label", { style: { display: "block", marginBottom: "8px", fontWeight: 500 }, children: ["Max Bar Width: ", maxBarWidth, "px", _jsx("span", { style: { fontWeight: 400, color: "#6b7280", marginLeft: "8px" }, children: "(Prevents bars from becoming too wide)" })] }), _jsx("input", { type: "range", min: "10", max: "120", value: maxBarWidth, onChange: (e) => setMaxBarWidth(Number(e.target.value)), style: { width: "100%" } }), _jsxs("div", { style: {
                                                display: "flex",
                                                justifyContent: "space-between",
                                                fontSize: "11px",
                                                color: "#6b7280",
                                                marginTop: "4px",
                                            }, children: [_jsx("span", { children: "10px" }), _jsx("span", { children: "120px" })] })] }), _jsxs("div", { style: { gridColumn: "1 / -1" }, children: [_jsxs("label", { style: { display: "block", marginBottom: "8px", fontWeight: 500 }, children: ["Container Width: ", containerWidth ? `${containerWidth}px` : "Auto (100%)"] }), _jsxs("div", { style: { display: "flex", gap: "8px", alignItems: "center" }, children: [_jsx("input", { type: "range", min: "400", max: "1400", step: "50", value: containerWidth || 1400, onChange: (e) => setContainerWidth(Number(e.target.value)), style: { flex: 1 }, disabled: !containerWidth }), _jsx("button", { onClick: () => setContainerWidth(containerWidth ? undefined : 800), style: {
                                                        padding: "6px 12px",
                                                        borderRadius: "6px",
                                                        border: "1px solid #e5e7eb",
                                                        ...
                                                        fontSize: "12px",
                                                        fontWeight: 500,
                                                    }, children: containerWidth ? "Auto" : "Fixed" })] }), _jsxs("div", { style: {
                                                display: "flex",
                                                justifyContent: "space-between",
                                                fontSize: "11px",
                                                color: "#6b7280",
                                                marginTop: "4px",
                                            }, children: [_jsx("span", { children: "400px" }), _jsx("span", { children: "1400px" })] })] })] }), _jsx("div", { style: {
                                marginTop: "20px",
                                padding: "12px",
                                backgroundColor: "#f3f4f6",
                                borderRadius: "6px",
                                fontSize: "13px",
                            }, children: _jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "12px" }, children: [_jsxs("div", { children: [_jsx("strong", { children: "Data Points:" }), " ", data.length] }), _jsxs("div", { children: [_jsx("strong", { children: "Bars per Category:" }), " ", variant === "stacked" ? 1 : 3] }), _jsxs("div", { children: [_jsx("strong", { children: "Total Bars:" }), " ", data.length * (variant === "stacked" ? 1 : 3)] })] }) })] }), _jsxs(Card, { children: [_jsxs("h3", { style: { marginTop: 0, marginBottom: "16px" }, children: [variant === "grouped" ? "📊 Grouped" : "📚 Stacked", " Bar Chart - Bar Width Test"] }), _jsx("div", { style: { width: containerWidth ? `${containerWidth}px` : "100%" }, children: _jsx(BarChartCondensed, { data: data, categoryKey: "quarter", variant: variant, maxBarWidth: maxBarWidth, width: containerWidth, height: 400, legend: true, grid: true, showYAxis: true, xAxisLabel: "Fiscal Quarter", yAxisLabel: "Amount ($)" }) })] }), _jsxs(Card, { style: { marginTop: "24px", padding: "20px" }, children: [_jsx("h3", { style: { marginTop: 0, marginBottom: "16px", fontSize: "16px", fontWeight: 600 }, children: "\uD83D\uDE80 Quick Test Presets" }), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px" }, children: [_jsxs("button", { onClick: () => {
                                        setDataSize("small");
                                        setVariant("grouped");
                                        setMaxBarWidth(60);
                                        ...
                                        cursor: "pointer",
                                        textAlign: "left",
                                    }, children: [_jsx("div", { style: { fontWeight: 600, marginBottom: "4px" }, children: "\uD83C\uDFAF Few Bars (Wide)" }), _jsx("div", { style: { fontSize: "12px", color: "#6b7280" }, children: "4 points, max 60px cap" })] }), _jsxs("button", { onClick: () => {
                                        setDataSize("xlarge");
                                        setVariant("grouped");
                                        setMaxBarWidth(60);
                                        setContainerWidth(undefined);
                                        ...
                                        cursor: "pointer",
                                        textAlign: "left",
                                    }, children: [_jsx("div", { style: { fontWeight: 600, marginBottom: "4px" }, children: "\uD83D\uDCC9 Many Bars (Thin)" }), _jsx("div", { style: { fontSize: "12px", color: "#6b7280" }, children: "50 points, auto-sized thin bars" })] }), _jsxs("button", { onClick: () => {
                                        setDataSize("large");
                                        setVariant("stacked");
                                        setMaxBarWidth(40);
                                        ...
                                        cursor: "pointer",
                                        textAlign: "left",
                                    }, children: [_jsx("div", { style: { fontWeight: 600, marginBottom: "4px" }, children: "\uD83D\uDD04 Fixed Container" }), _jsx("div", { style: { fontSize: "12px", color: "#6b7280" }, children: "24 points, stacked, 800px" })] }), _jsxs("button", { onClick: () => {
                                        setDataSize("medium");
                                        setVariant("grouped");
                                        setMaxBarWidth(100);
                                        setContainerWidth(undefined);
                                        ...
                                        cursor: "pointer",
                                        textAlign: "left",
                                    }, children: [_jsx("div", { style: { fontWeight: 600, marginBottom: "4px" }, children: "\uD83C\uDFA8 Large Max Width" }), _jsx("div", { style: { fontSize: "12px", color: "#6b7280" }, children: "Medium data, max 100px" })] }), _jsxs("button", { onClick: () => {
                                        setDataSize("small");
                                        setVariant("stacked");
                                        setMaxBarWidth(30);
                                        ...
                                        cursor: "pointer",
                                        textAlign: "left",
                                    }, children: [_jsx("div", { style: { fontWeight: 600, marginBottom: "4px" }, children: "\uD83D\uDCF1 Narrow Container" }), _jsx("div", { style: { fontSize: "12px", color: "#6b7280" }, children: "Small data, 400px width" })] }), _jsxs("button", { onClick: () => {
                                        setDataSize("xlarge");
                                        setVariant("stacked");
                                        setMaxBarWidth(20);
                                        setContainerWidth(undefined);
                                        ...
                                        cursor: "pointer",
                                        textAlign: "left",
                                    }, children: [_jsx("div", { style: { fontWeight: 600, marginBottom: "4px" }, children: "\uD83D\uDD2C Ultra Condensed" }), _jsx("div", { style: { fontSize: "12px", color: "#6b7280" }, children: "50 points, stacked, max 20px" })] })] })] })] }));
    },
};
//# sourceMappingURL=barChartCondensed.stories.js.map