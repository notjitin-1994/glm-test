...
export const DefaultConfiguration = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "700px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Monthly Revenue Analysis" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Comprehensive view of revenue distribution across 12 months" })] }), _jsx(RadialChart, { ...args })] })),
    parameters: {
        docs: {
            description: {
                story: `
...
export const ThemeShowcase = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "600px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Financial Growth Metrics" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Using the emerald theme for finance-related data visualization" })] }), _jsx(RadialChart, { ...args })] })),
    parameters: {
        docs: {
            description: {
                story: `
 ...
 */
export const VisualEnhancement = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "500px", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Revenue Distribution" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Enhanced with percentage display" })] }), _jsx(RadialChart, { ...args })] })),
    parameters: {
        docs: {
            description: {
                story: `
...
export const CustomPalette = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "600px", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Brand-Specific Color Scheme" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Using custom colors that align with your brand identity" })] }), _jsx(RadialChart, { ...args }), _jsxs("div", { style: {
                    marginTop: "16px",
                    padding: "12px",
                    ...
                    fontSize: "12px",
                    color: "#666",
                }, children: [_jsx("strong", { children: "\uD83C\uDFA8 Custom Palette:" }), " ", customColorPalette.slice(0, 8).map((color, index) => (_jsx("span", { style: {
...
export const LargeDatasetDemo = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "700px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Comprehensive Compensation Analysis" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Complete breakdown of 15 compensation categories with carousel navigation" })] }), _jsx(RadialChart, { ...args }), _jsxs("div", { style: {
                    marginTop: "16px",
                    padding: "12px",
                    backgroundColor: "#f8f9fa",
                    borderRadius: "6px",
                    fontSize: "12px",
                    color: "#666",
                }, children: [_jsx("strong", { children: "\uD83D\uDCA1 Carousel Feature:" }), " When legend items exceed available space, up/down navigation arrows automatically appear. Use the arrows to scroll through all legend items while maintaining chart visibility."] })] })),
    parameters: {
        docs: {
            description: {
                story: `
...
export const ResponsiveDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the edges or corners of the container below to see how the chart adapts" }), _jsxs("div", { style: {
                                ...
                                fontSize: "12px",
                                color: "#1565c0",
                            }, children: [_jsx("strong", { children: "\uD83C\uDFAF Try This:" }), " Resize the container to see automatic legend layout changes, chart proportion adjustments, and responsive breakpoint behaviors."] })] }), _jsxs(Card, { style: {
                        position: "relative",
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(RadialChart, { ...args }), _jsx("div", { style: { ...handleStyle, top: -2, left: 0, right: 0, height: 12, cursor: "ns-resize" }, onMouseDown: (e) => handleMouseDown(e, "n") }), _jsx("div", { style: {
                                ...handleStyle,
                                bottom: -2,
                                left: 0,
                                right: 0,
                                ...
                                fontWeight: "500",
                            }, children: [dimensions.width, "px \u00D7", " ", typeof dimensions.height === "number" ? `${dimensions.height}px` : "auto"] })] }), _jsxs("div", { style: {
                        marginTop: "16px",
                        padding: "12px",
                        backgroundColor: "#f8f9fa",
                        borderRadius: "6px",
                        fontSize: "12px",
                        color: "#666",
                    }, children: [_jsx("strong", { children: "\uD83D\uDCCA Responsive Features Demonstrated:" }), _jsxs("ul", { style: { margin: "8px 0 0 0", paddingLeft: "16px" }, children: [_jsx("li", { children: "Automatic chart scaling and proportion maintenance" }), _jsx("li", { children: "Legend layout adaptation (stacked \u2194 horizontal)" }), _jsx("li", { children: "Text size and spacing adjustments" }), _jsx("li", { children: "Optimal space utilization at any container size" })] })] })] }));
    },
    parameters: {
        docs: {
            description: {
...
//# sourceMappingURL=RadialChart.stories.js.map