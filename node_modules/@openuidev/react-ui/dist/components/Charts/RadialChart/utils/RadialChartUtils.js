 ...
 */
export const calculateRadialChartDimensions = (width) => {
 ...
 */
export const getRadialHoverStyles = (index, activeIndex) => {
    return {
 ...
 */
export const transformRadialDataWithPercentages = (data, dataKey, colors) => {
 ...
 */
export const useRadialChartHover = () => {
 ...
 */
export const createRadialAnimationConfig = (config = {}) => {
    return {
 ...
 */
export const createRadialEventHandlers = (onMouseEnter, onMouseLeave, onClick) => {
    return {
        onMouseEnter: onMouseEnter
            ? (data, index) => onMouseEnter(data, index)
            : undefined,
        onMouseLeave: onMouseLeave ? () => onMouseLeave() : undefined,
        onClick: onClick ? (data, index) => onClick(data, index) : undefined,
    };
};
// ==========================================
...
//# sourceMappingURL=RadialChartUtils.js.map