...
`,
        ...
        categoryKey: {
            description: "**Required.** The key in your data object that represents the category for the X-axis (e.g., 'date', 'month').",
            control: false,
            table: {
                type: { summary: "string" },
                category: "📊 Data Configuration",
        ...
        theme: {
            description: "Specifies the color palette for the chart's lines, tooltips, and legend. Ignored when customPalette is provided.",
            control: "select",
...
export const DataExplorer = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: {
                        ...
                        width: "600px",
                    }, children: [_jsx("strong", { children: "\uD83D\uDCC8 Line Chart Test Suite:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", flexWrap: "wrap", gap: "4px" }, children: [_jsx("button", { onClick: () => setSelectedDataType("default"), style: selectedDataType === "default" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Default (12 months)" }), _jsx("button", { onClick: () => setSelectedDataType("bigLabels"), style: selectedDataType === "bigLabels" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFF7\uFE0F Big Labels" }), _jsx("button", { onClick: () => setSelectedDataType("denseTimeline"), style: selectedDataType === "denseTimeline" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Dense Timeline (16 periods)" }), _jsx("button", { onClick: () => setSelectedDataType("companyNames"), style: selectedDataType === "companyNames" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFE2 Company Names" }), _jsx("button", { onClick: () => setSelectedDataType("countryData"), style: selectedDataType === "countryData" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDF0D Country Names" }), _jsx("button", { onClick: () => setSelectedDataType("financialQuarters"), style: selectedDataType === "financialQuarters" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Financial Quarters" }), _jsx("button", { onClick: () => setSelectedDataType("mixedLengths"), style: selectedDataType === "mixedLengths" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD24 Mixed Lengths" }), _jsx("button", { onClick: () => setSelectedDataType("edgeCases"), style: selectedDataType === "edgeCases" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFAF Edge Cases" }), _jsx("button", { onClick: () => setSelectedDataType("minimal"), style: selectedDataType === "minimal" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCF1 Minimal" }), _jsx("button", { onClick: () => setSelectedDataType("expandCollapseMarketing"), style: selectedDataType === "expandCollapseMarketing" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD04 Marketing Channels" })] })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(LineChart, { ...args, data: currentData, categoryKey: currentCategoryKey }) })] }));
    },
};
/**
 * ## Big Labels
...
export const BigLabelsStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "600px" }, children: _jsx(LineChart, { ...args }) })),
};
/**
 * ## Dense Timeline
 *
...
export const DenseTimelineStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "500px" }, children: _jsx(LineChart, { ...args }) })),
    parameters: {
        docs: {
            description: {
 ...
 */
export const StrokeCustomizationStory = {
    ...
    render: (args) => (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "20px" }, children: [_jsxs("div", { children: [_jsx("h4", { children: "Default Lines (strokeWidth: 2)" }), _jsx(Card, { style: { width: "500px" }, children: _jsx(LineChart, { ...args, strokeWidth: 2 }) })] }), _jsxs("div", { children: [_jsx("h4", { children: "Thick Lines (strokeWidth: 4)" }), _jsx(Card, { style: { width: "500px" }, children: _jsx(LineChart, { ...args, strokeWidth: 4 }) })] })] })),
};
/**
 * ## Line Variants
 *
 ...
 */
export const VariantComparisonStory = {
    name: "📐 Line Variants",
    args: {
    ...
    render: (args) => (_jsxs("div", { style: { display: "flex", flexDirection: "column", gap: "20px" }, children: [_jsxs("div", { children: [_jsx("h4", { style: { margin: "0 0 8px 0", fontSize: "14px", fontWeight: "600" }, children: "Linear Variant" }), _jsx(Card, { style: { width: "500px" }, children: _jsx(LineChart, { ...args, variant: "linear" }) })] }), _jsxs("div", { children: [_jsx("h4", { style: { margin: "0 0 8px 0", fontSize: "14px", fontWeight: "600" }, children: "Natural Variant (Smooth Curves)" }), _jsx(Card, { style: { width: "500px" }, children: _jsx(LineChart, { ...args, variant: "natural" }) })] }), _jsxs("div", { children: [_jsx("h4", { style: { margin: "0 0 8px 0", fontSize: "14px", fontWeight: "600" }, children: "Step Variant" }), _jsx(Card, { style: { width: "500px" }, children: _jsx(LineChart, { ...args, variant: "step" }) })] })] })),
    parameters: {
        docs: {
            description: {
                story: "Compares the three available line variants: linear (straight lines), natural (smooth curves), and step (stepped lines).",
            },
        },
    },
};
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    border: "1px solid #e9ecef",
                                ...
                                fontSize: "12px",
                                    ...
                                    } }), _jsx("span", { style: { fontFamily: "monospace" }, children: color })] }, index))) })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(LineChart, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
...
export const ResponsiveBehaviorDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the edges or corners of the container below to see how the chart adapts" }), _jsxs("div", { style: {
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(LineChart, { ...args }), _jsx("div", { style: { ...handleStyle, top: -2, left: 0, right: 0, height: 12, cursor: "ns-resize" }, onMouseDown: (e) => handleMouseDown(e, "n") }), _jsx("div", { style: {
                                ...handleStyle,
                                bottom: -2,
                                left: 0,
                                right: 0,
