...
export const BasicScatter = {
    ...
    render: (args) => _jsx(ScatterChart, { ...args }),
};
/**
...
export const CorrelationAnalysis = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "700px" }, children: _jsx(ScatterChart, { ...args }) })),
};
/**
 * ## Shape Comparison
 *
...
export const ShapeComparison = {
    ...
    render: (args) => {
        ...
        return (_jsx("div", { style: { display: "flex", flexDirection: "column", gap: "20px" }, children: shapes.map((shape) => (_jsxs("div", { children: [_jsxs("h4", { style: {
                            margin: "0 0 8px 0",
                            fontSize: "14px",
                            fontWeight: "600",
                            textTransform: "capitalize",
                        }, children: [shape, " Shape"] }), _jsx(Card, { style: { width: "500px", height: "600px" }, children: _jsx(ScatterChart, { ...args, shape: shape, height: "100%" }) })] }, shape))) }));
    },
};
/**
 * ## Data Explorer
...
export const DataExplorer = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: {
                        ...
                        width: "600px",
                    }, children: [_jsx("strong", { children: "\uD83D\uDCC8 Scatter Chart Test Suite:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", flexWrap: "wrap", gap: "4px" }, children: [_jsx("button", { onClick: () => setSelectedDataType("default"), style: selectedDataType === "default" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCCA Default" }), _jsx("button", { onClick: () => setSelectedDataType("correlation"), style: selectedDataType === "correlation" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Correlation" }), _jsx("button", { onClick: () => setSelectedDataType("multipleDatasets"), style: selectedDataType === "multipleDatasets" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFAF Multiple Datasets" }), _jsx("button", { onClick: () => setSelectedDataType("performance"), style: selectedDataType === "performance" ? activeButtonStyle : buttonStyle, children: "\u26A1 Performance" }), _jsx("button", { onClick: () => setSelectedDataType("comprehensive"), style: selectedDataType === "comprehensive" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDF0D Comprehensive" })] })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(ScatterChart, { ...args, data: currentData, height: "600px" }) })] }));
    },
};
//# sourceMappingURL=ScatterChart.stories.js.map