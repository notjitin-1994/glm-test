...
`,
        ...
        categoryKey: {
            description: "**Required.** The key in your data object that represents the category for the Y-axis (e.g., 'region', 'department').",
            control: false,
            table: {
                type: { summary: "string" },
                category: "📊 Data Configuration",
...
export const DataExplorer = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: {
                        ...
                        width: "700px",
                    }, children: [_jsx("strong", { children: "\uD83D\uDCA1 Quick Data Switch:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", flexWrap: "wrap", gap: "4px" }, children: [_jsx("button", { onClick: () => setSelectedDataType("default"), style: selectedDataType === "default" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCCA Default (5 categories)" }), _jsx("button", { onClick: () => setSelectedDataType("small"), style: selectedDataType === "small" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCF1 Small (3 items)" }), _jsx("button", { onClick: () => setSelectedDataType("large"), style: selectedDataType === "large" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDF10 Large (10 regions)" }), _jsx("button", { onClick: () => setSelectedDataType("simple"), style: selectedDataType === "simple" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFE2 Simple (4 departments)" }), _jsx("button", { onClick: () => setSelectedDataType("bigNumbers"), style: selectedDataType === "bigNumbers" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCB0 Big Numbers" }), _jsx("button", { onClick: () => setSelectedDataType("edge"), style: selectedDataType === "edge" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFAF Single Item" }), _jsx("button", { onClick: () => setSelectedDataType("singleGroup"), style: selectedDataType === "singleGroup" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDF0D Single Group" }), _jsx("button", { onClick: () => setSelectedDataType("mixedPositiveNegative"), style: selectedDataType === "mixedPositiveNegative" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Mixed +/-" }), _jsx("button", { onClick: () => setSelectedDataType("expandCollapseChannels"), style: selectedDataType === "expandCollapseChannels" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD04 Marketing Channels" })] }), _jsxs("div", { style: { marginTop: "8px", fontSize: "12px", color: "#666" }, children: [_jsx("strong", { children: "Current:" }), " ", selectedDataType, " | ", _jsx("strong", { children: "Items:" }), " ", currentData.length, " | ", _jsx("strong", { children: "Category:" }), " ", currentCategoryKey] })] }), _jsx(Card, { style: { width: "700px" }, children: _jsx(HorizontalBarChart, { ...args, data: currentData, categoryKey: currentCategoryKey }) })] }));
    },
};
...
export const Default = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "600px" }, children: _jsx(HorizontalBarChart, { ...args }) })),
};
...
export const CustomPaletteVibrant = {
...
//# sourceMappingURL=HorizontalBarChart.stories.js.map