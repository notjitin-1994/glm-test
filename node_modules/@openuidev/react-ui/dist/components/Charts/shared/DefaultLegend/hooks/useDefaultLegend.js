...
const GAP_WIDTH = 12;
export const useDefaultLegend = ({ items, containerWidth, buttonWidth, isExpanded, }) => {
    ...
    const displayItems = useMemo(() => (isExpanded ? items : visibleItems), [isExpanded, items, visibleItems]);
...
//# sourceMappingURL=useDefaultLegend.js.map