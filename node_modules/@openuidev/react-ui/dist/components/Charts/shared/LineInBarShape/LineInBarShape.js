...
const LineInBarShape = React.memo((props) => {
    ...
    const { rTL, rTR, rBL, rBR } = useMemo(() => {
        ...
        if ((variant === "grouped" && dimension < minDimension) ||
        ...
        if (Array.isArray(r)) {
            ...
            if (isVertical) {
                if (isNegative)
                    return { rTL: 0, rTR: 0, rBL: r, rBR: r };
                return { rTL: r, rTR: r, rBL: 0, rBR: 0 };
            }
            // For horizontal bars
            if (isNegative)
                return { rTL: r, rTR: 0, rBL: r, rBR: 0 };
    ...
    const { adjustedX, adjustedY, adjustedWidth, adjustedHeight } = useMemo(() => {
        ...
        if (isVertical) {
            ...
            if (h > 0) {
                const minHeight = variant === "grouped"
    ...
    const lineCoords = useMemo(() => {
        ...
        if (adjustedWidth < MIN_LINE_DIMENSION || height <= 0)
            return null;
    ...
    return (_jsxs("g", { children: [_jsx("path", { d: path, fill: fill, stroke: stroke, strokeWidth: strokeWidth, opacity: opacity }), lineCoords && (_jsx("line", { x1: lineCoords.x1, y1: lineCoords.y1, x2: lineCoords.x2, y2: lineCoords.y2, stroke: iLineColor, strokeWidth: iLineWidth, strokeLinecap: "round", opacity: opacity }))] }));
});
LineInBarShape.displayName = "LineInBarShape";
export { LineInBarShape };
//# sourceMappingURL=LineInBarShape.js.map