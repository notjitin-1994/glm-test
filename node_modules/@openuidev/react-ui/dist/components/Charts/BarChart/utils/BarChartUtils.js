 ...
 */
const getWidthOfData = (data, categoryKey, variant) => {
    if (data.length === 0) {
        return 0;
    }
 ...
 * @param variant - The variant of the chart.
 */
const getPadding = (data, categoryKey, containerWidth, variant) => {
 ...
 */
const getSnapPositions = (data, categoryKey, variant) => {
    if (data.length === 0)
        return [0];
...
//# sourceMappingURL=BarChartUtils.js.map