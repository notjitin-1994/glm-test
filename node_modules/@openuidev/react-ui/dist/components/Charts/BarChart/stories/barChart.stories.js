...
`,
        ...
        categoryKey: {
            description: "**Required.** The key in your data object that represents the category for the X-axis (e.g., 'month', 'department').",
            control: false,
            table: {
                type: { summary: "string" },
                category: "📊 Data Configuration",
        ...
        theme: {
            description: "Specifies the color palette for the chart's bars, tooltips, and legend. Ignored when customPalette is provided.",
            control: "select",
...
export const DataExplorer = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: {
                        ...
                        width: "700px",
                    }, children: [_jsx("strong", { children: "\uD83D\uDCA1 Quick Data Switch:" }), _jsxs("div", { style: { marginTop: "8px", display: "flex", flexWrap: "wrap", gap: "4px" }, children: [_jsx("button", { onClick: () => setSelectedDataType("default"), style: selectedDataType === "default" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC5 Default (12 months)" }), _jsx("button", { onClick: () => setSelectedDataType("small"), style: selectedDataType === "small" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCF1 Small (3 items)" }), _jsx("button", { onClick: () => setSelectedDataType("large"), style: selectedDataType === "large" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDF10 Large (18 months)" }), _jsx("button", { onClick: () => setSelectedDataType("weekly"), style: selectedDataType === "weekly" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Weekly (16 weeks)" }), _jsx("button", { onClick: () => setSelectedDataType("bigNumbers"), style: selectedDataType === "bigNumbers" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCB0 Big Numbers" }), _jsx("button", { onClick: () => setSelectedDataType("edge"), style: selectedDataType === "edge" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFAF Single Item" }), _jsx("button", { onClick: () => setSelectedDataType("numbers"), style: selectedDataType === "numbers" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD22 Number Ranges" }), _jsx("button", { onClick: () => setSelectedDataType("singleGroup"), style: selectedDataType === "singleGroup" ? activeButtonStyle : buttonStyle, children: "\uD83C\uDFE2 Single Group" }), _jsx("button", { onClick: () => setSelectedDataType("expandCollapseMarketing"), style: selectedDataType === "expandCollapseMarketing" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDD04 Marketing Channels" }), _jsx("button", { onClick: () => setSelectedDataType("positiveNegative"), style: selectedDataType === "positiveNegative" ? activeButtonStyle : buttonStyle, children: "\uD83D\uDCC8 Positive & Negative" })] }), _jsxs("div", { style: { marginTop: "8px", fontSize: "12px", color: "#666" }, children: [_jsx("strong", { children: "Current:" }), " ", selectedDataType, " | ", _jsx("strong", { children: "Items:" }), " ", currentData.length, " | ", _jsx("strong", { children: "Category:" }), " ", currentCategoryKey] })] }), _jsx(Card, { style: { width: "700px" }, children: _jsx(BarChart, { ...args, data: currentData, categoryKey: currentCategoryKey }) })] }));
    },
    parameters: {
        docs: {
            description: {
                story: "Use the buttons above the chart to quickly switch between different data variations and test the scrolling functionality. Active button is highlighted in blue.",
            },
        },
    },
};
...
export const SmallDataStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "400px" }, children: _jsx(BarChart, { ...args }) })),
};
/**
 ...
 */
export const WeeklyDataStory = {
    name: "📈 Weekly Data (Many Categories)",
    args: {
        data: dataVariations.weekly,
        categoryKey: "week",
        theme: "sunset",
        variant: "grouped",
        radius: 2,
...
export const BigNumbersStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "500px" }, children: _jsx(BarChart, { ...args }) })),
};
/**
 ...
 */
export const NumberRangesStory = {
    name: "🔢 Number Ranges (Scale Testing)",
    args: {
        data: dataVariations.numbers,
...
export const ExpandCollapseMarketingStory = {
    ...
    render: (args) => (_jsx(Card, { style: { width: "600px" }, children: _jsx(BarChart, { ...args }) })),
    parameters: {
        docs: {
            description: {
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    border: "1px solid #e9ecef",
                                ...
                                fontSize: "12px",
                                    ...
                                    } }), _jsx("span", { style: { fontFamily: "monospace" }, children: color })] }, index))) })] }), _jsx(Card, { style: { width: "600px" }, children: _jsx(BarChart, { ...args }) })] })),
    parameters: {
        docs: {
            description: {
...
export const ResponsiveBehaviorDemo = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { padding: "20px" }, children: [_jsxs("div", { style: { marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Responsive Behavior Demonstration" }), _jsx("p", { style: { margin: "0 0 12px 0", color: "#666", fontSize: "14px" }, children: "Drag the edges or corners of the container below to see how the chart adapts" }), _jsxs("div", { style: {
                                ...
                                fontSize: "12px",
                                color: "#1565c0",
                            }, children: [_jsx("strong", { children: "\uD83C\uDFAF Try This:" }), " Resize the container to see how the bar widths and layout adjustments."] })] }), _jsxs(Card, { style: {
                        position: "relative",
                        ...
                        overflow: "hidden",
                        cursor: "default",
                    }, children: [_jsx(BarChart, { ...args }), _jsx("div", { style: { ...handleStyle, top: -2, left: 0, right: 0, height: 12, cursor: "ns-resize" }, onMouseDown: (e) => handleMouseDown(e, "n") }), _jsx("div", { style: {
                                ...handleStyle,
                                bottom: -2,
                                left: 0,
                                right: 0,
