...
export const useMaxLabelHeight = (data, categoryKey, tickVariant, widthOfGroup = 70) => {
 ...
 */
export const useHorizontalBarLabelHeight = (data, categoryKey, labelWidth) => {
    const { theme: userTheme } = useTheme();
...
//# sourceMappingURL=useMaxLabelHeight.js.map