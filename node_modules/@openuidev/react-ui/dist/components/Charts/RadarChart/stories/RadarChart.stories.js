...
export const DefaultConfiguration = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "500px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Team Performance Analysis" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Comparing key performance indicators across three teams." })] }), _jsx(RadarChart, { ...args })] })),
    parameters: {
        docs: {
            description: {
                story: `
...
export const SkillsAssessment = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "500px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Developer Skill Levels" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Visualizing proficiency across different programming skills for various experience levels." })] }), _jsx(RadarChart, { ...args })] })),
    parameters: {
        docs: {
            description: {
                story: "This example uses the 'area' variant to represent different skill levels. The transparency allows for easy comparison of overlapping areas, providing a clear view of strengths and weaknesses across different roles.",
            },
        },
    },
};
export const TeamPerformance = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "500px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Team Performance Comparison" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Utilizing custom icons to distinguish teams in the legend for improved clarity." })] }), _jsx(RadarChart, { ...args })] })),
    parameters: {
        docs: {
            description: {
                story: "This chart demonstrates how to enhance the legend with custom icons. It's an effective way to visually associate data series with specific entities, like teams or products. The thicker stroke width also improves line visibility.",
            },
        },
    },
};
export const BusinessMetrics = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "500px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Quarterly Performance Review" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Tracking key business metrics across departments over four quarters." })] }), _jsx(RadarChart, { ...args })] })),
    parameters: {
        docs: {
            description: {
                story: "A comprehensive view of business performance, this example showcases how the 'area' variant can effectively display multiple overlapping datasets to reveal trends and patterns over time.",
            },
        },
    },
};
export const InteractivePlayground = {
    ...
    render: (args) => {
        ...
        return (_jsxs("div", { style: { width: "700px" }, children: [_jsxs(Card, { style: { padding: "20px", marginBottom: "20px" }, children: [_jsx("h3", { style: { margin: "0 0 12px 0", fontSize: "16px", fontWeight: "600" }, children: "\uD83D\uDD78\uFE0F Radar Chart Test Suite" }), _jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "6px" }, children: Object.keys(dataVariations).map((key) => (_jsx("button", { onClick: () => setSelectedDataType(key), style: selectedDataType === key ? activeButtonStyle : buttonStyle, children: key.replace(/([A-Z])/g, " $1").replace(/^./, (str) => str.toUpperCase()) }, key))) }), _jsxs("div", { style: { marginTop: "12px", fontSize: "12px", color: "#666" }, children: [_jsx("strong", { children: "Current Dataset:" }), " ", selectedDataType, " | ", _jsx("strong", { children: "Axes:" }), " ", currentData.length, " | ", _jsx("strong", { children: "Category Key:" }), " ", currentCategoryKey] })] }), _jsx(Card, { style: {
                        height: "400px",
                        padding: "24px",
                        resize: "both",
                        overflow: "hidden",
                        minWidth: "400px",
                        minHeight: "400px",
                    }, children: _jsx(RadarChart, { ...args, data: currentData, categoryKey: currentCategoryKey }) })] }));
    },
    parameters: {
        docs: {
            description: {
...
export const ThemeShowcase = {
    ...
    render: (args) => (_jsx("div", { style: {
            ...
            gap: "24px",
            width: "900px",
        }, children: ["ocean", "orchid", "emerald", "sunset", "spectrum", "vivid"].map((theme) => (_jsxs("div", { children: [_jsx("h4", { style: {
                        textAlign: "center",
                        marginBottom: "12px",
                        textTransform: "capitalize",
                        fontSize: "14px",
                        fontWeight: 600,
                    }, children: theme }), _jsx(Card, { style: { height: "fit-content", padding: "12px" }, children: _jsx(RadarChart, { ...args, theme: theme }) })] }, theme))) })),
    parameters: {
        docs: {
            description: {
                story: "This story showcases all available color themes. Each theme provides a professionally curated palette suitable for different branding and data contexts. Animations are disabled for quicker comparison.",
            },
        },
    },
};
    ...
    render: (args) => (_jsxs("div", { children: [_jsxs("div", { style: {
                    ...
                    border: "1px solid #e9ecef",
                                ...
                                fontSize: "12px",
                                    ...
                                    } }), _jsx("span", { style: { fontFamily: "monospace" }, children: color })] }, index))) })] }), _jsxs(Card, { style: { width: "500px", height: "auto", padding: "24px" }, children: [_jsxs("div", { style: { marginBottom: "16px" }, children: [_jsx("h3", { style: { margin: "0 0 8px 0", fontSize: "18px", fontWeight: "600" }, children: "Team Performance with Custom Colors" }), _jsx("p", { style: { margin: 0, color: "#666", fontSize: "14px" }, children: "Using custom brand colors to match your application's design system." })] }), _jsx(RadarChart, { ...args })] })] })),
    parameters: {
        docs: {
            description: {
                story: 'Demonstrates how to use the `customPalette` prop to provide your own color scheme for the radar chart. When `customPalette` is provided, it overrides the `theme` prop and uses your specified colors instead of the predefined theme palettes.\n\n**Key Features:**\n- 🎨 **Custom Colors**: Override default theme colors with your own palette\n- 🔄 **Theme Override**: The `theme` prop is ignored when `customPalette` is provided\n- 📊 **Consistent Distribution**: Colors are distributed evenly across data series\n- 🎯 **Brand Matching**: Perfect for matching your application\'s brand colors\n\n**Usage:**\n```tsx\n<RadarChart\n  data={data}\n  categoryKey="metric"\n  customPalette={["#FF6B6B", "#4ECDC4", "#45B7D1"]}\n  // theme prop is ignored when customPalette is provided\n/>\n```',
            },
        },
    },
};
//# sourceMappingURL=RadarChart.stories.js.map