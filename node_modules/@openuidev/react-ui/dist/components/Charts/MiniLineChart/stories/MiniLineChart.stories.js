...
const meta = {
    ...
    argTypes: {
        data: {
            description: "An array of numbers or an array of objects with value and optional label. Each entry represents a single point in the line chart.",
            control: false,
            table: {
        ...
        theme: {
            description: "The color palette theme for the chart. Each theme provides a different color for the line.",
            control: "select",
        ...
        variant: {
            description: "The interpolation method used to create the line curves. 'linear' creates straight lines between points, 'natural' creates smooth curves, and 'step' creates a stepped line.",
            control: "radio",
...
export const SimpleNumberArray = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "280px", padding: "20px" }, children: [_jsx("h3", { style: { marginBottom: "16px", fontSize: "16px", fontWeight: "600" }, children: "Daily Activity" }), _jsx(MiniLineChart, { ...args })] })),
    parameters: {
        docs: {
            source: {
                code: `
...
export const LabeledData = {
    ...
    render: (args) => (_jsxs(Card, { style: { width: "320px", padding: "20px" }, children: [_jsx("h3", { style: { marginBottom: "16px", fontSize: "16px", fontWeight: "600" }, children: "Monthly Revenue" }), _jsx(MiniLineChart, { ...args })] })),
    parameters: {
        docs: {
            source: {
                code: `
...
//# sourceMappingURL=MiniLineChart.stories.js.map