...
const meta = {
    ...
    argTypes: {
        ...
        theme: {
            control: false,
            description: "The theme of the code block, see theme options [here](https://github.com/react-syntax-highlighter/react-syntax-highlighter/blob/master/AVAILABLE_STYLES_PRISM.MD)",
            table: {
                category: "Appearance",
