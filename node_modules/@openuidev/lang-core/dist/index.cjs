...
function createLibrary(input) {
	...
	const reg = zod_v4_core.registry();
	...
	return {
		...
		toJSONSchema() {
			const combinedSchema = (0, zod_v4.object)(Object.fromEntries(Object.entries(componentsRecord).map(([k, v]) => [k, v.props])));
			return zod_v4_core.toJSONSchema(combinedSchema, { metadata: reg });
		}
	};
}
//#endregion
...
exports.ACTION_STEPS = ACTION_STEPS;
exports.BUILTINS = BUILTINS;
exports.BUILTIN_NAMES = BUILTIN_NAMES;
exports.BuiltinActionType = BuiltinActionType;
exports.LAZY_BUILTINS = LAZY_BUILTINS;
...
exports.enrichErrors = enrichErrors;
exports.evaluate = evaluate;
exports.evaluateElementProps = evaluateElementProps;
exports.extractToolResult = extractToolResult;
exports.generatePrompt = generatePrompt;
exports.isASTNode = isASTNode;
exports.isBuiltin = isBuiltin;
exports.isReactiveAssign = isReactiveAssign;
exports.isReactiveSchema = isReactiveSchema;
exports.isRuntimeExpr = isRuntimeExpr;
exports.markReactive = markReactive;
exports.mergeStatements = mergeStatements;
exports.parse = parse;
exports.parseRules = parseRules;
exports.parseStructuredRules = parseStructuredRules;
exports.resolveStateField = resolveStateField;
exports.stripReactiveAssign = stripReactiveAssign;
exports.tagSchemaId = tagSchemaId;
